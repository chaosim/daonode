...
(function() {
  var ExpressionError, Trail, TypeError, Var, any, any1, any2, char, core, defaultHash, defaultPureHash, dqstring, general, greedyany1, greedyany2, greedysome1, greedysome2, lazyany1, lazyany2, lazysome1, lazysome2, lisp, logic, name, numberTimes1Fun, numberTimes2Fun, parallelFun, solve, some1, some2, special, sqstring, times, times1, times1Fun, times2, times2Fun, _, _ref,
  ...
  exports.char = char = special(1, 'char', function(solver, cont, x) {
    return function(v) {
  ...
  exports.quoteString = special(1, 'quoteString', function(solver, cont, quote) {
    return function(v) {
      var length, p, pos, string, text, _ref1;
