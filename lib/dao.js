...
(function() {
  ...
  exports.Solver = (function() {
    function Solver(faildone, state) {
      this.faildone = faildone != null ? faildone : faildone;
      this.state = state;
    ...
    Solver.prototype.solve = function(exp, toCont) {
      ...
      return this.trail.getvalue(this.run(null, fromCont, toCont));
    };

    Solver.prototype.run = function(value, cont, toCont) {
      var _ref;
  ...
  exports.done = done = function(v) {
    return [done, v];
  };

  exports.faildone = faildone = function(v) {
    return [faildone, v];
  };
  ...
  exports.Fun2 = (function(_super) {
    ...
    Fun2.prototype.applyCont = function(solver, cont, args) {
      ...
      return solver.argsCont(args, function(params) {
        return [solver.cont(_this.fun.apply(_this, params), cont), params];
      });
    };
