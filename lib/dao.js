...
(function() {
  var ArgumentError, ArityError, BindingError, Command, DummyVar, Error, ExpressionError, Macro, Trail, TypeError, UArray, UObject, UnquoteSliceValue, Var, commandMaker, debug, done, faildone, nameToIndexMap, reElements, special, uarray, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
  ...
  Trail = exports.Trail = (function() {
    ...
    Trail.prototype.getvalue = function(x, memo) {
      ...
      return (x != null ? typeof x.getvalue === "function" ? x.getvalue(this, memo) : void 0 : void 0) || x;
    };
  ...
  exports.Apply = (function() {
    function Apply(caller, args) {
      ...
      if (this.caller instanceof Macro) {
        this.id = (Apply.id++).toString();
      }
    }
    ...
    Apply.prototype.cont = function(solver, cont) {
      return this.caller.applyCont(solver, cont, this);
    };
  ...
  exports.Special = (function(_super) {
    ...
    Special.prototype.applyCont = function(solver, cont, apply) {
      return this.fun.apply(this, [solver, cont].concat(__slice.call(apply.args)));
    };
  ...
  exports.Fun = (function(_super) {
    ...
    Fun.prototype.applyCont = function(solver, cont, apply) {
      var _this = this;

      return solver.argsCont(apply.args, function(params, solver) {
  ...
  exports.Macro = Macro = (function(_super) {
    ...
    Macro.prototype.applyCont = function(solver, cont, apply) {
      var exp, id, idMap, result;

      exp = this.fun.apply(this, apply.args);
      idMap = Macro.idMap;
      id = apply.id;
      if (!idMap[id]) {
        idMap[id] = true;
  ...
  exports.Proc = (function(_super) {
    ...
    Proc.prototype.applyCont = function(solver, cont, apply) {
      var _this = this;
      ...
      return function(v, solver) {
        ...
        result = _this.fun.apply(_this, apply.args);
