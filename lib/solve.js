...
(function() {
  var Cons, DummyVar, Error, SolverFail, SolverFinish, Trail, TypeError, UArray, UObject, Var, uarray, _, _ref,
  ...
  exports.SolverFinish = SolverFinish = (function() {
    function SolverFinish(value) {
      this.value = value;
    }
  ...
  exports.SolverFail = SolverFail = (function() {
    function SolverFail(value) {
      this.value = value;
    }
  ...
  exports.Solver = (function() {
    ...
    Solver.prototype.run = function(func) {
      var e, v;
