...
(function() {
  ...
  Trail = exports.Trail = (function() {
    ...
    Trail.prototype.set = function(vari, value) {
      if (!this.hasOwnProperty(vari.name)) {
        return this[vari.name] = [vari, value];
      }
    };

    Trail.prototype.undo = function() {
      var name, pair, value, vari, _results;
      ...
      for (name in this) {
        ...
        value = pair[1];
        vari.binding = value;
        _results.push(this.$solver$.vars[vari.name] = value);
      }
      return _results;
    };
  ...
  exports.Apply = (function() {
    function Apply(caller, args) {
      var arity, length, ok, x, _i, _len, _ref5, _ref6;
      ...
      if (!ok) {
        ...
        for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
          x = _ref5[_i];
          if ((x != null ? (_ref6 = x.caller) != null ? _ref6.name : void 0 : void 0) === "unquoteSlice") {
            return;
          }
        }
  ...
  exports.Special = (function(_super) {
    ...
    function Special() {
      _ref5 = Special.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  exports.Fun = (function(_super) {
    ...
    function Fun() {
      _ref6 = Fun.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  exports.Macro = (function(_super) {
    ...
    function Macro() {
      _ref7 = Macro.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  exports.Proc = (function(_super) {
    ...
    function Proc() {
      _ref8 = Proc.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
