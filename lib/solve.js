...
(function() {
  var ArgumentError, ArityError, BindingError, Command, DummyVar, Error, ExpressionError, MAXBINDINGCHAINLENGTH, Trail, TypeError, UnquoteSliceValue, Var, commandMaker, debug, done, faildone, nameToIndexMap, reElements, special, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    __slice = [].slice,
  ...
  exports.solve = function(exp, cont, failcont, trail) {
    if (cont == null) {
      cont = done;
    }
    if (failcont == null) {
    ...
    exports.status = exports.UNKNOWN;
    return new exports.Solver(failcont, trail).solve(exp, cont);
  };

  exports.solver = function(failcont, trail, state) {
    if (failcont == null) {
      failcont = faildone;
    }
    if (trail == null) {
    ...
    return new exports.Solver(failcont, trail, state);
  };

  exports.Solver = (function() {
    function Solver(failcont, trail, state) {
  ...
  Var = exports.Var = (function() {
    ...
    Var.prototype.deref = function(trail) {
      var chains, i, length, next, v, x, _i, _j, _ref5, _ref6;
      ...
      if (next === this || !(next instanceof Var)) {
        ...
        while (1) {
          ...
          length++;
          if (next === v) {
            for (i = _i = 0, _ref5 = chains.length - 2; 0 <= _ref5 ? _i < _ref5 : _i > _ref5; i = 0 <= _ref5 ? ++_i : --_i) {
              x = chains[i];
              x.binding = next;
            ...
            for (i = _j = 0, _ref6 = chains.length - 1; 0 <= _ref6 ? _j < _ref6 : _j > _ref6; i = 0 <= _ref6 ? ++_j : --_j) {
              x = chains[i];
              x.binding = next;
              trail.set(x, chains[i + 1]);
            }
  ...
  exports.vars = function(names) {
    var name, _i, _len, _ref5, _results;

    _ref5 = split(names, reElements);
    _results = [];
  ...
  exports.DummyVar = DummyVar = (function(_super) {
    ...
    function DummyVar() {
      _ref5 = DummyVar.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  exports.Apply = (function() {
    function Apply(caller, args) {
      ...
      if (!ok) {
        ...
        for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
          x = _ref6[_i];
          if ((x != null ? (_ref7 = x.caller) != null ? _ref7.name : void 0 : void 0) === "unquoteSlice") {
            return;
          }
        }
    ...
    Apply.prototype.quasiquote = function(solver, cont) {
      ...
      args = this.args;
      for (i = _i = _ref6 = args.length - 1; _i >= 0; i = _i += -1) {
        cont = (function(i, cont) {
  ...
  exports.Special = (function(_super) {
    ...
    function Special() {
      _ref6 = Special.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  exports.Fun = (function(_super) {
    ...
    function Fun() {
      _ref7 = Fun.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  exports.Macro = (function(_super) {
    ...
    function Macro() {
      _ref8 = Macro.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  exports.Proc = (function(_super) {
    ...
    function Proc() {
      _ref9 = Proc.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
