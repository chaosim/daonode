...
(function() {
  ...
  exports.inc = special(1, 'inc', function(compiler, cont, item) {
    return il["return"](cont.call(il.inc.apply([item.interlang()])));
  });

  exports.suffixinc = special(1, 'suffixinc', function(compiler, cont, item) {
    return il["return"](cont.call(il.suffixinc.apply([item.interlang()])));
  });

  exports.dec = special(1, 'dec', function(compiler, cont, item) {
    return il["return"](cont.call(il.dec.apply([item.interlang()])));
  });

  exports.suffixdec = special(1, 'suffixdec', function(compiler, cont, item) {
    return il["return"](cont.call(il.suffixdec.apply([item.interlang()])));
  });
