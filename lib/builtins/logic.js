...
(function() {
  var Env, Var, binaryPredicate, macro, notunifyFun, notunifyList, notunifyListFun, orpFun, solve, special, unaryPredicate, unifyFun, unifyList, unifyListFun,
    __slice = [].slice;
  ...
  exports.appendFailcont = special(1, 'setFailcont', function(solver, cont, fun) {
    return function(v, solver) {
      var fc;
  ...
  orpFun = function() {
    var args, cont, env, fc, length, orcont, solver, state, x, xcont, y, ycont;
    ...
    return function(v, solver) {
      ...
      state = solver.state;
      if (state) {
        state = (typeof state.copy === "function" ? state.copy() : void 0) || (typeof state.clone === "function" ? state.clone() : void 0) || state.slice(0) || state;
      }
      fc = solver.failcont;
  ...
  exports.freep = special(1, 'freep', function(solver, cont, x) {
    return function(v, solver) {
      if (solver.env.deref(x) instanceof Var) {
        return cont(true, solver);
      } else {
        return solver.failcont(false, solver);
      }
