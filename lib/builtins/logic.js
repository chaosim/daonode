...
(function() {
  var Trail, Var, binaryPredicate, macro, notunifyFun, notunifyList, notunifyListFun, orpFun, solve, special, unaryPredicate, unifyFun, unifyList, unifyListFun,
    __slice = [].slice;
  ...
  */
  ...
  exports.rule = function(arity, name, fun) {
    ...
    return macro(arity, name, function() {
      var args, body, clauses, head, i, result;
      ...
      result = (function() {
        ...
        _results = [];
        for (i = _i = 0, _ref = clauses.length - 1; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          head = clauses[i][0];
          body = clauses[i][1];
