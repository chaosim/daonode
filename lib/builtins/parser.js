  ...
  exports.purememo = function(caller, name, hash) {
    ...
    return special(1, 'memo', function() {
      ...
      return function(v, solver) {
        ...
        if (hashValue === void 0) {
          return realCont(v, solver);
        } else {
          if (_memoPureResult.hasOwnProperty(hashValue)) {
            return cont(_memoPureResult[hashValue], solver);
          } else {
            result = (_ref1 = realCont(v, solver), newCont = _ref1[0], v = _ref1[1], solver = _ref1[2], _ref1);
      ...
      return function(v, solver) {
        ...
        if (hash === void 0) {
          ...
          if (exports._memoResult.hasOwnProperty(hash)) {
            ...
            result = (_ref2 = realCont(v, solver), v = _ref2[0], solver = _ref2[1], _ref2);
