...
(function() {
  var Env, ExpressionError, TypeError, Var, any1, any2, checkFunction, dao, dqstring, general, greedyany1, greedyany2, greedysome1, greedysome2, lazyany1, lazyany2, lazysome1, lazysome2, lisp, logic, name, numberTimes1Fun, numberTimes2Fun, parallelFun, solve, some1, some2, special, sqstring, times1, times1Fun, times2, times2Fun, _, _ref,
    __slice = [].slice,
  ...
  _ref = (function() {
    ...
    _ref = "Env, solve, Var,  ExpressionError, TypeError, special".split(", ");
    _results = [];
    ...
    return _results;
  })(), Env = _ref[0], solve = _ref[1], Var = _ref[2], ExpressionError = _ref[3], TypeError = _ref[4], special = _ref[5];
  ...
  exports.seplist = function(exp, options) {
    var andp, appendFailcont, bind, expectTimes, freep, getvalue, i, ifp, inc, is_, list, n, newVar, one, push, pushp, result, sep, sub, succeed, template;
    ...
    freep = logic.freep;
    ifp = logic.ifp;
    appendFailcont = logic.appendFailcont;
    list = general.list;
    push = general.push;
    pushp = general.pushp;
    one = lisp.one;
    ...
    if (expectTimes === null) {
      ...
      if (result === null) {
        ...
        return andp(bind(result, []), ifp(freep(expectTimes), andp(exp, one(i), push(result, getvalue(template)), any(andp(sep, exp, push(result, getvalue(template)), inc(i), appendFailcont(function() {
          result.binding.pop();
          return i.binding--;
  ...
  exports.followChar = special(1, 'followChar', function(solver, cont, arg) {
    return function(v, solver) {
      var c, data, env, pos, x, _ref1;
  ...
  exports.float = special(1, 'float', function(solver, cont, arg) {
    return function(v, solver) {
