...
(function() {
  ...
  exports.purememo = function(caller, name, hash) {
    ...
    return special(1, 'purememo', function() {
  ...
  exports.memo = function(caller, name, hash) {
    ...
    return special(1, 'memo', function() {
      ...
      if (hashValue === void 0) {
        ...
        return function(v) {
          var newCont, result, _ref1, _ref2;

          if (solver.memo.hasOwnProperty(hashValue)) {
            _ref1 = solver.memo[hashValue], result = _ref1[0], solver.state = _ref1[1];
            return cont(result);
          } else {
  ...
  exports.clearmemo = special(1, 'clearmemo', function(solver, cont) {
    return function(v) {
      solver.memo = {};
      return cont(v);
    };
