...
(function() {
  var INDEX, ObjecttoString, andp, any, assign, begin, bind, block, break_, char, charIn, charWhen, continue_, defaultLabel, funcall, getvalue, greedyany, headList, if_, iff, inc, incp, index, io, isArray, isInteger, isLabel, isNumber, isObject, isString, jsbreak, jscontinue, jsfun, jsfuncall, lambda, lazyany, list, listTail, macro, makeLabel, name, not_, orp, orp2, orp3, push, pushp, quasiquote, sideEffect, string, stringIn, stringIn0, stringWhile, stringWhile0, times, unify, uniqueconst, uniquevar, unquote, unquoteSlice, vari, variable, _i, _j, _len, _ref, _ref1, _results,
    __slice = [].slice,
