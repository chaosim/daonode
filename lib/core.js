    ...
    Compiler.prototype.specials = {
      ...
      'findall': function(cont, goal, result, template) {
        ...
        if (result == null) {
          ...
          return il.begin(il.assign(result1, []), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v2, il.assign(v1, v2), il.if_(il.unify(this.interlang(result), result1), il.begin(il.setfailcont(fc), cont.call(null)), fc.call(v1)))), this.cont(goal, this.clamda(v, il.assign(v1, v), il.push(result1, il.getvalue(this.interlang(template))), il.failcont.call(v1))));
        }
      },
    ...
    Compiler.prototype.specialsAlpha = {
      ...
      "macro": function() {
        ...
        result.push((function() {
          ...
          for (_k = 0, _len2 = params.length; _k < _len2; _k++) {
            p = params[_k];
            _results.push(this.alphaMacroParam(p));
          }
          return _results;
        }).call(this));
        for (_k = 0, _len2 = body.length; _k < _len2; _k++) {
