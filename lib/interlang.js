...
(function() {
  ...
  il.number = vop('number', (function(compiler) {
    ...
    args = this.args;
    return "parser.number(" + (compiler.toCode(args[0])) + ")";
  }), il.EFFECT);
  ...
  il.quoteString = vop('quoteString', (function(compiler) {
    ...
    args = this.args;
    return "parser.quoteString(" + (compiler.toCode(args[0])) + ")";
  }), il.EFFECT);

  il.identifier = vop('identifier', (function(compiler) {
    var args;

    args = this.args;
    return "parser.identifier(" + (compiler.toCode(args[0])) + ")";
  }), il.EFFECT);
  ...
  il.excludes = ['evalexpr', 'failcont', 'run', 'getvalue', 'fake', 'findCatch', 'popCatch', 'pushCatch', 'protect', 'suffixinc', 'suffixdec', 'dec', 'inc', 'unify', 'bind', 'undotrail', 'newTrail', 'newLogicVar', 'char', 'followChars', 'notFollowChars', 'charWhen', 'stringWhile', 'stringWhile0', 'number', 'literal', 'followLiteral', 'quoteString', 'uobject'];
