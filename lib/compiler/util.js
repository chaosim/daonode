...
(function() {
  ...
  exports.lazysome = function(exp, result, template) {
    ...
    if (result == null) {
      ...
      result1 = internalvar('result');
      return begin(assign(result1, list()), exp, push(result1, getvalue(template)), lazyany(andp(exp, push(result1, getvalue(template)))), unify(result, result1));
    }
  };
  ...
  exports.greedysome = function(exp, result, template) {
    ...
    if (result == null) {
      ...
      result1 = internalvar('result');
      return begin(assign(result1, list()), exp, push(result1, getvalue(template)), greedyany(andp(exp, push(result1, getvalue(template)))), unify(result, result1));
    }
  };
  ...
  exports.times = function(exp, expectTimes, result, template) {
    ...
    n = internalvar('n');
    if (result == null) {
      return begin(assign(n, 0), lazyany(andp(exp, inc(n))), unify(expectTimes, n));
    } else {
      result1 = internalvar('result');
      return begin(assign(n, 0), assign(result1, list()), lazyany(andp(exp, inc(n), push(result1, getvalue(template)))), unify(expectTimes, n), unify(result, result1));
    }
  };
