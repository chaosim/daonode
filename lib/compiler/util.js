...
(function() {
  var block, break_, charIn, charWhen, continue_, defaultLabel, e, if_, iff, il, instance, io, isLabel, jsfun, lambda, macro, makeLabel, name, not_, orp, quasiquote, sideEffect, string, stringIn, stringIn0, stringWhile, stringWhile0, unquote, unquoteSlice, vop, _, _o,
    __slice = [].slice,
