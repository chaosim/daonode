...
(function() {
  var block, break_, continue_, defaultLabel, e, if_, iff, il, instance, io, isLabel, jsfun, lambda, macro, makeLabel, name, not_, orp, quasiquote, sideEffect, string, unquote, unquoteSlice, vop, _, _o,
    __slice = [].slice,
