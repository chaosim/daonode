...
(function() {
  var andp, any, assign, begin, bind, block, break_, char, charIn, charWhen, continue_, defaultLabel, e, getvalue, greedyany, if_, iff, il, inc, incp, index, instance, internalvar, io, isLabel, jsfun, lambda, lazyany, list, macro, makeLabel, name, not_, orp, push, pushp, quasiquote, sideEffect, string, stringIn, stringIn0, stringWhile, stringWhile0, times, unify, unquote, unquoteSlice, vari, vop, _, _o,
    __slice = [].slice,
