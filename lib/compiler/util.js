...
(function() {
  var andp, block, break_, charIn, charWhen, continue_, defaultLabel, e, if_, iff, il, instance, io, isLabel, jsfun, lambda, macro, makeLabel, name, not_, orp, quasiquote, sideEffect, string, stringIn, stringIn0, stringWhile, stringWhile0, unquote, unquoteSlice, vop, _, _o,
    __slice = [].slice,
  ...
  exports.getvalue = function(term) {
  ...
  exports.lazyany = function(exp) {
    return ['lazyany', exp];
  };

  exports.greedyany = function(exp) {
  ...
  exports.lazysome = function(exp) {
    return andp(exp, ['lazyany', exp]);
  };

  exports.greedysome = function(exp) {
