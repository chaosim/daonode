...
(function() {
  var block, break_, continue_, defaultLabel, excludes, if_, iff, il, io, isLabel, jsfun, lambda, macro, makeLabel, name, not_, quasiquote, sideEffect, string, unquote, unquoteSlice, vop, _, _o,
    __slice = [].slice,
  ...
  exports.sideEffect = sideEffect = function(exp) {
    return ["sideEffect", exp];
  };
