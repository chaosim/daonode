...
(function() {
  ...
  expressionToCode = function(compiler, exp) {
    if (exp instanceof Var || exp instanceof VirtualOperation && (exp.name === 'attr' || exp.name === 'index')) {
  ...
  isAtomic = function(exp) {
    return _.isString(exp) || _.isNumber(exp);
  };
  ...
  il.array = vop('array', function(compiler) {
    ...
    return "[" + (((function() {
      ...
      for (_i = 0, _len = args.length; _i < _len; _i++) {
        e = args[_i];
        _results.push(expressionToCode(compiler, e));
      }
      return _results;
    })()).join(', ')) + "]";
  });
