...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, CApply, Clamda, Code, Deref, Element, Env, Fun, IO, If, JSFun, Lamda, ListAssign, MAX_EXTEND_CODE_SIZE, NotImplement, Print, Return, Symbol, Throw, UnaryOperation, Var, VirtualOperation, analyze, applySideEffect, augmentAssign, binary, boolize, codeSize, core, expsEffect, hasOwnProperty, il, insertReturn, isEmpty, isStatement, jsify, optimize, pure, sideEffect, solve, toString, unary, vop, vop2, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref5 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref6 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  ListAssign.prototype.optimize = function(env, compiler) {
    var a, left, lefts, _i, _len, _ref7;
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref7, _ref8;
    ...
    return !!((_ref8 = caller.func) != null ? _ref8.apply(null, this.args) : void 0) || void 0;
  };
  ...
  ListAssign.prototype.jsify = function() {
    ...
    return il.begin.apply(il, (function() {
      ...
      _results = [];
      for (i = _i = 0, _ref7 = lefts.length; 0 <= _ref7 ? _i < _ref7 : _i > _ref7; i = 0 <= _ref7 ? ++_i : --_i) {
  ...
  Deref.prototype.toCode = function(compiler) {
    return "$trail.deref(" + (compiler.toCode(this.exp)) + ")";
  };
  ...
  binary = function(symbol, func) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref7 = Binary.__super__.constructor.apply(this, arguments);
        return _ref7;
      }
  ...
  unary = function(symbol, func) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref7 = Unary.__super__.constructor.apply(this, arguments);
        return _ref7;
      }
  ...
  augmentAssign = function(operator, func) {
    ...
    AugAssign = (function(_super) {
      ...
      function AugAssign() {
        _ref7 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref7;
      }
  ...
  il.pushCatch = vop('pushCatch', function(compiler) {
    ...
    args = this.args;
    return "$pushCatch(" + il.catches + ", " + (compiler.toCode(args[0])) + ", " + (compiler.toCode(args[1])) + ")";
  });
  ...
  il.popCatch = vop('popCatch', function(compiler) {
    ...
    args = this.args;
    return "$popCatch(" + il.catches + ", " + (compiler.toCode(args[0])) + ")";
  });
  ...
  il.findCatch = vop('findCatch', (function(compiler) {
    ...
    args = this.args;
    return "$findCatch(" + il.catches + ", " + (compiler.toCode(args[0])) + ")";
  }), il.PURE);
  ...
  il.fake = vop('fake', function(compiler) {
    ...
    args = this.args;
    return "$fake(" + (compiler.toCode(args[0])) + ")";
  }).apply([]);
  ...
  il.restore = vop('restore', function(compiler) {
    ...
    args = this.args;
    return "$restore(" + (compiler.toCode(args[0])) + ")";
  });
  ...
  il.getvalue = vop('getvalue', (function(compiler) {
    ...
    args = this.args;
    return "$trail.getvalue(" + (compiler.toCode(args[0])) + ")";
  }), il.PURE);
  ...
  il.run = vop('run', function(compiler) {
    ...
    args = this.args;
    return "$run(" + (compiler.toCode(args[0])) + ", " + (compiler.toCode(args[1])) + ")";
  });
  ...
  il.unify = vop('unify', function(compiler) {
    ...
    args = this.args;
    return "$trail.unify(" + (compiler.toCode(args[0])) + ", " + (compiler.toCode(args[1])) + ")";
  });
  ...
  il.bind = vop('bind', function(compiler) {
    ...
    args = this.args;
    return "" + (compiler.toCode(args[0])) + ".bind(" + (compiler.toCode(args[1])) + ", $trail)";
  });
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref7;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref7 = bindings.length; _i < _ref7; i = _i += 2) {
