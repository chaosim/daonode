...
(function() {
  var Apply, Array, Assign, Begin, BinaryOperation, BinaryOperationApply, CApply, Clamda, Code, Deref, Element, Fun, If, JSCallable, Lamda, NotImplement, Print, Return, UnaryOperation, UnaryOperationApply, Var, VirtualOperation, VirtualOperationApply, binary, il, insertReturn, isStatement, jsify, toString, unary, vop, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
    __slice = [].slice,
  ...
  Var.prototype.jsify = function(compiler) {
    return this;
  };

  Assign.prototype.jsify = function(compiler) {
    return this;
  };

  Return.prototype.jsify = function(compiler) {
    throw "Return should not occur before jsify.";
  };

  If.prototype.jsify = function(compiler) {
    return new If(this.test, compiler.jsify(this.then_), compiler.jsify(this.else_));
  };

  Begin.prototype.jsify = function(compiler) {
  ...
  Lamda.prototype.jsify = function(compiler) {
    var body;

    body = this.body.jsify(compiler);
    body = insertReturn(body);
    return new Lamda(this.params, body);
  };

  Clamda.prototype.jsify = function(compiler) {
    var body;
  ...
  Apply.prototype.jsify = function(compiler) {
    return new Apply(compiler.jsify(this.caller), this.args);
  };

  CApply.prototype.jsify = function(compiler) {
    return new CApply(this.cont.jsify(compiler), this.value);
  };
