...
(function() {
  ...
  ClamdaBody = (function(_super) {
    ...
    function ClamdaBody() {
      _ref8 = ClamdaBody.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  IdCont = (function(_super) {
    ...
    function IdCont() {
      _ref9 = IdCont.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref10 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref11 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  ListAssign.prototype.optimize = function(env, compiler) {
    var a, left, lefts, _i, _len, _ref12;
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, k, locals, p, result, _i, _len, _ref12;
  ...
  Begin.prototype.optimize = function(env, compiler) {
    var e, exp, result, _i, _len, _ref12;
  ...
  Lamda.prototype.optimizeApply = function(args, env, compiler) {
    ...
    exps.push(this.body);
    return new Apply(new Lamda([], compiler.optimize(il.begin.apply(il, exps), env)), []);
  };
  ...
  VirtualOperation.prototype.boolize = function() {
    ...
    return !!((_ref13 = this.func) != null ? _ref13.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref12, _ref13;
    ...
    return !!((_ref13 = caller.func) != null ? _ref13.apply(null, this.args) : void 0) || void 0;
  };
  ...
  ListAssign.prototype.jsify = function() {
    ...
    return il.begin.apply(il, (function() {
      ...
      _results = [];
      for (i = _i = 0, _ref12 = lefts.length; 0 <= _ref12 ? _i < _ref12 : _i > _ref12; i = 0 <= _ref12 ? ++_i : --_i) {
  ...
  binary = function(symbol, func) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref12 = Binary.__super__.constructor.apply(this, arguments);
        return _ref12;
      }
  ...
  unary = function(symbol, func) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref12 = Unary.__super__.constructor.apply(this, arguments);
        return _ref12;
      }
  ...
  augmentAssign = function(operator, func) {
    var AugAssign, _ref12;

    AugAssign = (function(_super) {
      __extends(AugAssign, _super);

      function AugAssign() {
        _ref12 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref12;
      }
  ...
  vop = function(name, toCode, _effect) {
    ...
    Vop = (function(_super) {
      ...
      function Vop() {
        _ref12 = Vop.__super__.constructor.apply(this, arguments);
        return _ref12;
      }
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref12;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref12 = bindings.length; _i < _ref12; i = _i += 2) {
