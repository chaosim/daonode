...
(function() {
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref8, _ref9;
    ...
    return !!((_ref9 = caller.func) != null ? _ref9.apply(null, this.args) : void 0) || void 0;
  };
  ...
  il.attr = il.pure(vop('attr', function(compiler, args) {
    return "(" + (compiler.toCode(args[0])) + ")." + (compiler.toCode(args[1]));
  }));
  ...
  il.newLogicVar = vop('newLogicVar', function(compiler, args) {
    return "new Var(" + (compiler.toCode(args[0])) + ")";
  });

  il.unify = vop('unify', function(compiler, args) {
    return "$trail.unify(" + (compiler.toCode(args[0])) + ", " + (compiler.toCode(args[1])) + ")";
  });

  il.undotrail = vop('undotrail', function(compiler, args) {
  ...
  il.newTrail = vop('newTrail', function(compiler, args) {
    return "new Trail()";
  }).call();
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref8;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref8 = bindings.length; _i < _ref8; i = _i += 2) {
