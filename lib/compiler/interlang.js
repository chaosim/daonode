...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, CApply, Clamda, ClamdaBody, Code, Deref, Element, Env, Fun, GlobalVar, IO, IdCont, If, JSFun, Lamda, LetLamda, ListAssign, MAX_EXTEND_CODE_SIZE, NotImplement, Print, RecursiveClamda, Return, Symbol, Throw, TopBegin, UnaryOperation, Var, VirtualOperation, analyze, applySideEffect, augmentAssign, begin, binary, boolize, codeSize, core, expsEffect, hasOwnProperty, il, insertReturn, isEmpty, isStatement, jsify, optimize, pure, replace, sideEffect, solve, toString, unary, vop, vop2, _, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  Clamda = (function(_super) {
    ...
    Clamda.prototype.call = function(value) {
      return replace(this.body, this.v.name, value);
    };
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, k, locals, p, result, _i, _len, _ref13;
