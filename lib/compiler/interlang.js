...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, CApply, Clamda, ClamdaBody, Code, Deref, Element, Env, Fun, IO, IdCont, If, JSFun, Lamda, LetLamda, ListAssign, MAX_EXTEND_CODE_SIZE, NotImplement, Print, Return, Symbol, Throw, UnaryOperation, Var, VirtualOperation, analyze, applySideEffect, augmentAssign, binary, boolize, codeSize, core, expsEffect, hasOwnProperty, il, insertReturn, isEmpty, isStatement, jsify, optimize, pure, sideEffect, solve, toString, unary, vop, vop2, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  Symbol = (function(_super) {
    ...
    function Symbol() {
      _ref1 = Symbol.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  AugmentAssign = (function(_super) {
    ...
    function AugmentAssign() {
      _ref2 = AugmentAssign.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Throw = (function(_super) {
    ...
    function Throw() {
      _ref3 = Throw.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Print = (function(_super) {
    ...
    function Print() {
      _ref4 = Print.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  LetLamda = (function(_super) {
    ...
    function LetLamda() {
      _ref5 = LetLamda.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  ClamdaBody = (function(_super) {
    ...
    function ClamdaBody() {
      _ref6 = ClamdaBody.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  IdCont = (function(_super) {
    ...
    function IdCont() {
      _ref7 = IdCont.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref8 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref9 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  ListAssign.prototype.optimize = function(env, compiler) {
    var a, left, lefts, _i, _len, _ref10;
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, k, locals, p, result, _i, _len, _ref10;
    ...
    locals = (function() {
      ...
      for (_j = 0, _len1 = bindings.length; _j < _len1; _j++) {
        k = bindings[_j];
        if (hasOwnProperty.call(bindings, k) && __indexOf.call(this.params, k) < 0) {
          _results.push(k);
        }
      }
      return _results;
    ...
    if (locals.length !== 0) {
      body = il.begin(il.vardecl.apply(il, locals), body);
    }
    result = new Lamda(this.params, body);
    result.refMap = {};
  ...
  Clamda.prototype.optimize = function(env, compiler) {
    var bindings, body, k, locals, result;
    ...
    locals = (function() {
      ...
      for (_i = 0, _len = bindings.length; _i < _len; _i++) {
        k = bindings[_i];
        if (hasOwnProperty.call(bindings, k) && k !== this.v) {
          _results.push(k);
        }
      }
      return _results;
  ...
  Begin.prototype.optimize = function(env, compiler) {
    var e, exp, result, _i, _len, _ref10;
  ...
  LetLamda.prototype.optimizeApply = function(args, env, compiler) {
    var bindings, body, exps, i, p, pair, params, paramsLength, pi, temps, _i, _j, _k, _len, _len1, _len2, _ref10;
    ...
    exps.push(body);
    for (i = _k = 0, _len2 = temps.length; _k < _len2; i = ++_k) {
      pair = temps[i];
      _ref10 = temps[i], p = _ref10[0], pi = _ref10[1];
      exps.push(il.assign(p, pi));
    }
    return il.begin.apply(il, exps).optimize(env, compiler);
  };
  ...
  Clamda.prototype.optimizeApply = function(args, env, compiler) {
    ...
    if (sideEffect(value)) {
      switch (count) {
        case 0:
        case void 0:
          if (value instanceof Lamda || value instanceof Clamda) {
            return compiler.optimize(body, env);
          } else {
          ...
          break;
        default:
          return il.begin(il.assign(v, value), compiler.optimize(body, env.extend(v, v)));
      }
    } else {
  ...
  VirtualOperation.prototype.boolize = function() {
    ...
    return !!((_ref11 = this.func) != null ? _ref11.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref10, _ref11;
    ...
    return !!((_ref11 = caller.func) != null ? _ref11.apply(null, this.args) : void 0) || void 0;
  };
  ...
  ListAssign.prototype.jsify = function() {
    ...
    return il.begin.apply(il, (function() {
      ...
      _results = [];
      for (i = _i = 0, _ref10 = lefts.length; 0 <= _ref10 ? _i < _ref10 : _i > _ref10; i = 0 <= _ref10 ? ++_i : --_i) {
  ...
  binary = function(symbol, func) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref10 = Binary.__super__.constructor.apply(this, arguments);
        return _ref10;
      }
  ...
  unary = function(symbol, func) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref10 = Unary.__super__.constructor.apply(this, arguments);
        return _ref10;
      }
  ...
  augmentAssign = function(operator, func) {
    var AugAssign, _ref10;

    AugAssign = (function(_super) {
      __extends(AugAssign, _super);

      function AugAssign() {
        _ref10 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref10;
      }
  ...
  vop = function(name, toCode, _effect) {
    ...
    Vop = (function(_super) {
      ...
      function Vop() {
        _ref10 = Vop.__super__.constructor.apply(this, arguments);
        return _ref10;
      }
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref10;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref10 = bindings.length; _i < _ref10; i = _i += 2) {
  ...
  il.listlet = function() {
    var body, i, length, params, value, values, varsValue, _i, _ref10;

    varsValue = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    length = varsValue.length;
    params = varsValue.slice(0, length - 1);
