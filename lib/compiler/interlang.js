...
(function() {
  ...
  Assign.prototype.optimize = function(env, compiler) {
    var a, assign, exp, left, _ref16, _ref17;
    ...
    if (left instanceof VirtualOperation) {
      ...
      if (left instanceof UserVar) {
        if ((_ref16 = env.userlamda) != null) {
          _ref16.locals[left] = left;
        }
      } else {
        if ((_ref17 = env.lamda) != null) {
          _ref17.locals[left] = left;
        }
      }
    }
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, p, _i, _len, _ref16;
