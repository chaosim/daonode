...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, Break, Clamda, Continue, Deref, DoWhile, Element, Env, ExpressionList, For, ForIn, ForOf, Fun, IO, IdCont, If, InternalVar, JSFun, LabelStatement, Lamda, LocalDecl, MAX_EXTEND_CODE_SIZE, New, NonlocalDecl, NotImplement, Print, RecursiveClamda, Return, Symbol, Throw, TopBegin, Try, UnaryOperation, UserLamda, UserVar, Var, VirtualOperation, While, applySideEffect, augmentAssign, augmentOperators, begin, binary, boolize, codeSize, core, expressionToCode, expsEffect, hasOwnProperty, il, insertReturn, isAtomic, isDeclaration, isEmpty, isJsified, isParam, isStatement, isValue, jsify, optimize, pure, replace, setJsified, sideEffect, solve, toString, unary, varattr, vari, vop, vop2, _, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  New = (function(_super) {
    ...
    function New() {
      _ref6 = New.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  RecursiveClamda = (function(_super) {
    ...
    function RecursiveClamda() {
      _ref11 = RecursiveClamda.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  IdCont = (function(_super) {
    ...
    function IdCont() {
      _ref12 = IdCont.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref13 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref14 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
  ...
  Continue = (function(_super) {
    ...
    function Continue() {
      _ref15 = Continue.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, envValue, k, locals, newEnv, nonlocals, p, parentBindings, parentLamda, parentVars, v, vars, _i, _len, _ref16;
    ...
    this.body = jsify(body, compiler, newEnv);
    this._jsified = true;
  ...
  Begin.prototype.optimize = function(env, compiler) {
    var e, exp, exps, result, waitPop, _i, _len, _ref16;
  ...
  VirtualOperation.prototype.boolize = function() {
    ...
    return !!((_ref17 = this.func) != null ? _ref17.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref16, _ref17;
    ...
    return !!((_ref17 = caller.func) != null ? _ref17.apply(null, this.args) : void 0) || void 0;
  };
  ...
  binary = function(symbol, func, effect) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref16 = Binary.__super__.constructor.apply(this, arguments);
        return _ref16;
      }
  ...
  unary = function(symbol, func, effect) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref16 = Unary.__super__.constructor.apply(this, arguments);
        return _ref16;
      }
  ...
  augmentAssign = function(operator, func) {
    var AugAssign, _ref16;

    AugAssign = (function(_super) {
      __extends(AugAssign, _super);

      function AugAssign() {
        _ref16 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref16;
      }
  ...
  il.listassign = function() {
    ...
    return il.begin.apply(il, (function() {
      ...
      _results = [];
      for (i = _j = 0, _ref16 = lefts.length; 0 <= _ref16 ? _j < _ref16 : _j > _ref16; i = 0 <= _ref16 ? ++_j : --_j) {
  ...
  vop = function(name, toCode, _effect) {
    ...
    Vop = (function(_super) {
      ...
      function Vop() {
        _ref16 = Vop.__super__.constructor.apply(this, arguments);
        return _ref16;
      }
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref16;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref16 = bindings.length; _i < _ref16; i = _i += 2) {
