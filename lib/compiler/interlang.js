...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, CApply, Clamda, ClamdaBody, Code, Deref, Element, Env, Fun, IO, IdCont, If, JSFun, Lamda, ListAssign, MAX_EXTEND_CODE_SIZE, NotImplement, Print, Return, Symbol, Throw, UnaryOperation, Var, VirtualOperation, analyze, applySideEffect, augmentAssign, binary, boolize, codeSize, core, expsEffect, hasOwnProperty, il, insertReturn, isEmpty, isStatement, jsify, optimize, pure, sideEffect, solve, toString, unary, vop, vop2, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
  ...
  ClamdaBody = (function(_super) {
    ...
    function ClamdaBody() {
      _ref5 = ClamdaBody.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  IdCont = (function(_super) {
    ...
    function IdCont() {
      _ref6 = IdCont.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref7 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref8 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  ListAssign.prototype.optimize = function(env, compiler) {
    var a, left, lefts, _i, _len, _ref9;
  ...
  Begin.prototype.optimize = function(env, compiler) {
    var e, exp, result, _i, _len, _ref9;
    ...
    if (sideEffect(value)) {
      switch (count) {
        ...
        case void 0:
          ...
          break;
        default:
          return il.begin(il.assign(v, value), il.clamdabody(v, compiler.optimize(body, env.extend(v, v))));
      }
    } else {
  ...
  VirtualOperation.prototype.boolize = function() {
    ...
    return !!((_ref10 = this.func) != null ? _ref10.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref10, _ref9;
    ...
    return !!((_ref10 = caller.func) != null ? _ref10.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Assign.prototype.jsify = function() {
    ...
    if (exp instanceof Begin) {
      ...
      il.begin.apply(il, exps.slice(0, length - 1).concat([assign]));
    }
  ...
  ListAssign.prototype.jsify = function() {
    ...
    return il.begin.apply(il, (function() {
      var _i, _ref9, _results;

      _results = [];
      for (i = _i = 0, _ref9 = lefts.length; 0 <= _ref9 ? _i < _ref9 : _i > _ref9; i = 0 <= _ref9 ? ++_i : --_i) {
  ...
  binary = function(symbol, func) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref9 = Binary.__super__.constructor.apply(this, arguments);
        return _ref9;
      }
  ...
  unary = function(symbol, func) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref9 = Unary.__super__.constructor.apply(this, arguments);
        return _ref9;
      }
  ...
  augmentAssign = function(operator, func) {
    ...
    AugAssign = (function(_super) {
      ...
      function AugAssign() {
        _ref9 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref9;
      }
  ...
  vop = function(name, toCode, _effect) {
    ...
    Vop = (function(_super) {
      ...
      function Vop() {
        _ref9 = Vop.__super__.constructor.apply(this, arguments);
        return _ref9;
      }
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref9;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref9 = bindings.length; _i < _ref9; i = _i += 2) {
  ...
  il.listlet = function() {
    var body, i, length, params, value, values, varsValue, _i, _ref9;
    ...
    values = [];
    for (i = _i = 0, _ref9 = length - 1; 0 <= _ref9 ? _i < _ref9 : _i > _ref9; i = 0 <= _ref9 ? ++_i : --_i) {
