...
(function() {
  var Apply, Assign, AugmentAssign, Begin, BinaryOperation, BlockLamda, BlockVar, Break, Clamda, Continue, Deref, DoWhile, Element, Env, ExpressionList, For, ForIn, ForOf, Fun, IO, IdCont, If, InternalVar, JSFun, LabelStatement, Lamda, LocalDecl, MAX_EXTEND_CODE_SIZE, New, NonlocalDecl, NotImplement, Print, RecursiveClamda, Return, Symbol, TailRecursiveLamda, Throw, Try, UnaryOperation, UserLamda, UserVar, Var, VirtualOperation, While, applySideEffect, augmentAssign, augmentOperators, binary, boolize, codeSize, convertBlockLamdaBody, convertTailRecursive, convertTailResursiveCall, core, expressionToCode, expsEffect, hasCallOf, hasOwnProperty, il, insertReturn, isAtomic, isDeclaration, isEmpty, isJsified, isParam, isStatement, isValue, jsify, optimize, postOptimize, pure, replace, setJsified, sideEffect, solve, toString, unary, varattr, vari, vop, vop2, _, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  TailRecursiveLamda = (function(_super) {
    __extends(TailRecursiveLamda, _super);

    function TailRecursiveLamda() {
      _ref11 = TailRecursiveLamda.__super__.constructor.apply(this, arguments);
      return _ref11;
    }

    return TailRecursiveLamda;
  ...
  RecursiveClamda = (function(_super) {
    ...
    function RecursiveClamda() {
      _ref12 = RecursiveClamda.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  IdCont = (function(_super) {
    ...
    function IdCont() {
      _ref13 = IdCont.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
  ...
  BinaryOperation = (function(_super) {
    ...
    function BinaryOperation() {
      _ref14 = BinaryOperation.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
  ...
  UnaryOperation = (function(_super) {
    ...
    function UnaryOperation() {
      _ref15 = UnaryOperation.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
  ...
  Continue = (function(_super) {
    ...
    function Continue() {
      _ref16 = Continue.__super__.constructor.apply(this, arguments);
      return _ref16;
    }
  ...
  Assign.prototype.optimize = function(env, compiler) {
    var a, assign, exp, lamda, left, userlamda;
  ...
  Lamda.prototype.optimize = function(env, compiler) {
    var bindings, body, envValue, k, locals, newEnv, nonlocals, p, parentBindings, parentLamda, parentVars, v, vars, _i, _len, _ref17;
  ...
  Begin.prototype.optimize = function(env, compiler) {
    var e, exp, result, _i, _len, _ref17;
  ...
  VirtualOperation.prototype.boolize = function() {
    ...
    return !!((_ref18 = this.func) != null ? _ref18.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Apply.prototype.boolize = function() {
    var a, caller, _i, _len, _ref17, _ref18;
    ...
    return !!((_ref18 = caller.func) != null ? _ref18.apply(null, this.args) : void 0) || void 0;
  };
  ...
  Throw.prototype.jsify = function(compiler, env) {
    return this;
  };
  ...
  Return.prototype.convertTailRecursive = function(lamda) {
    ...
    if (value instanceof If) {
      ...
      if (result === lamda.vari) {
        ...
        return il.begin(steps, il.assign(lamda.vari, result));
      }
    } else {
  ...
  Apply.prototype.convertTailResursiveCall = function(lamda, steps) {
    var a, args, i, param, params, _i, _ref17;

    if (this.caller === lamda.vari) {
      params = lamda.params;
      args = this.args;
      for (i = _i = 0, _ref17 = args.length; 0 <= _ref17 ? _i < _ref17 : _i > _ref17; i = 0 <= _ref17 ? ++_i : --_i) {
        a = args[i];
        param = params[i];
        if (a.toString() !== param) {
      ...
      return new Apply((function() {
        var _j, _len, _ref18, _results;

        _ref18 = this.args;
        _results = [];
        for (_j = 0, _len = _ref18.length; _j < _len; _j++) {
          a = _ref18[_j];
  ...
  il.taillamda = function() {
    var body, params;

    params = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return new TailRecursiveLamda(params, il.begin.apply(il, body));
  };
  ...
  binary = function(symbol, func, effect) {
    ...
    Binary = (function(_super) {
      ...
      function Binary() {
        _ref17 = Binary.__super__.constructor.apply(this, arguments);
        return _ref17;
      }
  ...
  unary = function(symbol, func, effect) {
    ...
    Unary = (function(_super) {
      ...
      function Unary() {
        _ref17 = Unary.__super__.constructor.apply(this, arguments);
        return _ref17;
      }
  ...
  augmentAssign = function(operator, func) {
    var AugAssign, _ref17;

    AugAssign = (function(_super) {
      __extends(AugAssign, _super);

      function AugAssign() {
        _ref17 = AugAssign.__super__.constructor.apply(this, arguments);
        return _ref17;
      }
  ...
  il.listassign = function() {
    ...
    return il.begin.apply(il, (function() {
      var _j, _ref17, _results;

      _results = [];
      for (i = _j = 0, _ref17 = lefts.length; 0 <= _ref17 ? _j < _ref17 : _j > _ref17; i = 0 <= _ref17 ? ++_j : --_j) {
  ...
  vop = function(name, toCode, _effect) {
    ...
    Vop = (function(_super) {
      ...
      function Vop() {
        _ref17 = Vop.__super__.constructor.apply(this, arguments);
        return _ref17;
      }
  ...
  il.let_ = function() {
    var bindings, body, i, params, values, _i, _ref17;

    bindings = arguments[0], body = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    params = [];
    values = [];
    for (i = _i = 0, _ref17 = bindings.length; _i < _ref17; i = _i += 2) {
