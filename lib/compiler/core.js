...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      var done, exps, lamda, lamdaVars, locals, nonlocals, v, v2;
      ...
      exp = exp.optimize(new OptimizationEnv(null, {}, lamdaVars), this);
      exp = exp.jsify();
  ...
  exports.OptimizationEnv = OptimizationEnv = (function(_super) {
    ...
    function OptimizationEnv(outer, bindings, vars) {
    ...
    OptimizationEnv.prototype.extend = function(vari, value, vars) {
      var bindings;

      bindings = {};
      bindings[vari] = value;
      return new OptimizationEnv(this, bindings, vars);
    };

    OptimizationEnv.prototype.extendBindings = function(bindings, vars) {
      return new OptimizationEnv(this, bindings, vars);
    };
    ...
    OptimizationEnv.prototype.locals = function() {
      return this._locals || this.outer.locals();
    };

    OptimizationEnv.prototype.nonlocals = function() {
      return this._nonlocals || this.outer.nonlocals();
    };

    OptimizationEnv.prototype.userlocals = function() {
      return this._userlocals || this.outer.userlocals();
    };

    OptimizationEnv.prototype.usernonlocals = function() {
