...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      v = il.vari('v');
      fromCont = this.cont(exp, this.clamda(v, v));
    ...
    Compiler.prototype.clamda = function() {
      ...
      cont = il.clamda.apply(il, [v].concat(__slice.call(body)));
      this.globalCont = il.clamda(v, this.globalCont.call(il.clamda.apply(il, [v].concat(__slice.call(body))).call(v)));
      return cont;
    };
    ...
    Compiler.prototype.leftValueCont = function(cont, op, item, exp) {
      ...
      if (_.isString(item)) {
        v = il.vari('v');
        if (op === 'assign') {
          return this.cont(exp, this.clamda(v, il.assign(il.vari(item), v), cont.call(v)));
        } else {
      ...
      if (head === "index") {
        ...
        v = il.vari('v');
        if (op === 'assign') {
          cont1 = this.cont(exp, this.clamda(v, il.assign(il.index.call(obj, i), cont.call(v))));
        } else {
          cont1 = cont.call(il[op].call(il.index.call(obj, i)));
        }
        return this.cont(object, this.clamda(obj, this.cont(index, il.clamda(i, cont1))));
      } else {
    ...
    Compiler.prototype.specials = {
      ...
      "eval": function(cont, exp, path) {
        ...
        v = il.vari('v');
        p = il.vari('path');
        return this.cont(exp, this.clamda(v, this.cont(path, this.clamda(p, cont.call(il.evalexpr.call(v, p))))));
      },
      ...
      "jsfun": function(cont, func) {
        ...
        v = il.vari('v');
        return this.cont(func, this.clamda(v, cont.call(il.jsfun(v))));
      },
      "lambda": function() {
        ...
        return cont.call(il.lamda(params, this.expsCont(body, this.clamda(v, v))));
      },
      "funcall": function() {
      ...
      "macro": function() {
        var body, cont, e, p, params, params1, v;
        ...
        return cont.call(il.lamda(params1, this.expsCont(body, this.clamda(v, v))));
      },
      ...
      "macall": function() {
        ...
        for (i = _i = _ref = length - 1; _i >= 0; i = _i += -1) {
          cont = (function(i, cont) {
            return compiler.clamda(params[i], cont).call(il.lamda([], compiler.cont(args[i], compiler.clamda(v, v))));
          })(i, cont);
        }
        return this.cont(caller, this.clamda(f, cont));
      },
      ...
      'block': function() {
        ...
        fun = this.clamda(il.vari('v'), null);
        continues.push(f);
      ...
      'catch': function() {
        var cont, forms, formsCont, tag, v, v2;

        cont = arguments[0], tag = arguments[1], forms = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
        v = il.vari('v');
        v2 = il.vari('v');
        formsCont = this.expsCont(forms, il.clamda(v2, il.popCatch.apply([v]), cont.call(v2)));
        return this.cont(tag, il.clamda(v, il.pushCatch.apply([v, cont]), formsCont));
      },
      'throw': function(cont, tag, form) {
        ...
        v = il.vari('v');
        v2 = il.vari('v');
        formCont = il.clamda(v, this.cont(form, il.clamda(v2, this.protect(il.findCatch.apply([v])).call(v2))));
        return this.cont(tag, formCont);
      },
      'unwind-protect': function() {
        var cleanup, cont, form, oldprotect, result, v1, v2;
        ...
        v2 = il.vari('v');
        this.protect = function(cont) {
          return il.clamda(v1, this.expsCont(cleanup, il.clamda(v2, oldprotect(cont).call(v1))));
        };
      ...
      if (head === "unquote") {
        ...
        for (i = _i = _ref = exp.length - 1; _i >= 1; i = _i += -1) {
          ...
          if (_.isArray(e) && e.length > 0 && e[0] === "unquote-slice") {
            cont = this.quasiquote(e, this.clamda(v, il.assign(quasilist, il.concat.call(quasilist, v)), cont));
          } else {
            cont = this.quasiquote(e, this.clamda(v, il.push.call(quasilist, v), cont));
          }
        }
