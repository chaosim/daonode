...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      exps = [il.assign(il.uservar('_'), il.require('underscore')), il.assign(il.uservar('__slice'), il.attr([], il.symbol('slice'))), il.assign(il.uservar('solve'), il.attr(il.require('f:/daonode/lib/compiler/core.js'), il.symbol('solve'))), il.assign(il.uservar('parser'), il.require('f:/daonode/lib/compiler/parser.js')), il.assign(il.uservar('solvecore'), il.require('f:/daonode/lib/compiler/solve.js')), il.assign(il.uservar('SolverFinish'), il.attr(il.uservar('solvecore'), il.symbol('SolverFinish'))), il.assign(il.uservar('Solver'), il.attr(il.uservar('solvecore'), il.symbol('Solver'))), il.assign(il.uservar('Trail'), il.attr(il.uservar('solvecore'), il.symbol('Trail'))), il.assign(il.uservar('Var'), il.attr(il.uservar('solvecore'), il.symbol('Var'))), il.assign(il.uservar('DummyVar'), il.attr(il.uservar('solvecore'), il.symbol('DummyVar'))), il.assign(il.uservar('solver'), il["new"](il.symbol('Solver').call())), il.assign(il.uservar('UArray'), il.attr(il.uservar('solvecore'), il.symbol('UArray'))), il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, done), il.assign(il.cutcont, il.failcont), il.run(il.transparentuserlamda([], this.cont(exp, done)))];
    ...
    Compiler.prototype.specials = {
      ...
      'findall': function(cont, goal, result, template) {
        ...
        if (result == null) {
          ...
          return il.begin(il.assign(result1, []), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v2, il.assign(v1, v2), il.if_(il.unify(result, result1), fc.call(v1), il.begin(il.setfailcont(fc), cont.call(null))))), this.cont(exp, this.clamda(v, il.assign(v1, v), il.push(result1, il.getvalue(template)), il.failcont.call(v1))));
        }
      },
