  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.leftValueCont = function(cont, task, item, exp, op) {
      ...
      if (_.isString(item)) {
        ...
        switch (task) {
          case 'assign':
            return this.cont(exp, il.clamda(v, il.assign(item, v), cont.call(v)));
          case 'augment-assign':
            return this.cont(exp, il.clamda(v, new augmentOperators[op](item, v), cont.call(v)));
          case 'incp':
            fc = il.vari('fc');
      ...
      if (head === "index") {
        ...
        switch (task) {
          case 'assign':
            cont1 = this.cont(exp, il.clamda(v, il.assign(item, v), cont.call(v)));
            break;
          case 'augment-assign':
            cont1 = this.cont(exp, il.clamda(v, new augmentOperators[op](item, v), cont.call(v)));
            break;
          case 'incp':
            fc = il.vari('fc');
    ...
    Compiler.prototype.specials = {
      ...
      'pushp': function(cont, list, value) {
        ...
        fc = il.vari('fc');
        v = il.vari('v');
        return this.cont(list, il.clamda(list1, this.cont(value, il.clamda(value1, il.let_([fc, il.failcont], il.setfailcont(il.clamda(v, il.pop(list1), fc.call(v))), il.push(list1, value1), cont.call(value1))))));
      },
      ...
      'ifp': function(cont, test, action) {
        ...
        v = il.vari('v');
        fc = il.vari('fc');
        return il.let_([fc, il.failcont], this.cont(test, il.clamda(v, il.setfailcont(fc), this.cont(action, cont))));
      },
      ...
      'findall': function(cont, goal, result, template) {
        ...
        if (result == null) {
          ...
          return il.let_([result1, [], fc, il.failcont], il.setfailcont(il.clamda(v, il.if_(il.unify(result, result1), fc.call(v), il.begin(il.setfailcont(fc), cont.call(v))))), this.cont(exp, il.clamda(v, il.push(result1, il.getvalue(template)), il.failcont.call(v))));
        }
      },
      'once': function(cont, goal) {
        ...
        fc = il.vari('fc');
        v = il.vari('v');
        return il.let_([fc, il.failcont], this.cont(goal, il.clamda(v, il.setfailcont(fc), cont.call(v))));
      },
      ...
      'parallel': function(cont, x, y, checkFunction) {
        ...
        right = il.vari('right');
        v = il.vari('v');
        return il.let_([state, il.state], this.cont(x, il.clamda(v, il.assign(right, il.state), il.setstate(state), this.cont(y, il.clamda(v, il.if_(il.fun(checkFunction).call(il.state, right), cont.call(v), il.failcont.call(false)))))));
      },
