...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.newvar = function(v) {
      if (_.isString(v)) {
        return this.env.newvar(il.internallocal(v));
      } else {
    ...
    Compiler.prototype.getvar = function(v) {
      if (_.isString(v)) {
        return this.env.getvar(il.userlocal(v));
      } else {
    ...
    Compiler.prototype.lookup = function(v) {
      if (_.isString(v)) {
        return this.env.lookup(il.userlocal(v));
      } else {
