  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'catch': function() {
        ...
        v = this.il_vari('v');
        v2 = this.il_vari('v');
        temp1 = this.il_vari('temp');
        temp2 = this.il_vari('temp');
      ...
      'pushp': function(cont, list, value) {
        ...
        list2 = this.il_vari('list');
        value2 = this.il_vari('value');
        fc = this.il_vari('fc');
        v = this.il_vari('v');
      ...
      'notp': function(cont, goal) {
        ...
        state = this.il_vari('state');
        fc = this.il_vari('fc');
        return il.begin(il.assign(trail, il.trail), il.assign(fc, il.failcont), il.assign(state, il.state), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, v, il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(null))), this.cont(goal, fc));
      },
      ...
      'any': function(cont, exp) {
        ...
        v = this.il_vari('v');
        v1 = this.il_vari('v');
        return il.begin(il.assign(anyCont, il.recclamda(v, il.begin(il.assign(fc, il.failcont), il.assign(trail, il.trail), il.assign(state, il.state), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, il.assign(v1, v), il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(v1))), this.cont(exp, anyCont)))), anyCont.call(null));
      },
