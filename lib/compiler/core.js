...
(function() {
  var ArgumentError, ArityError, BindingError, Clamda, Command, Cons, DummyVar, Error, ExpressionError, Macro, Trail, TypeError, UArray, UObject, UnquoteSliceValue, Var, clamda, commandMaker, debug, dummy, nameToIndexMap, reElements, special, uarray, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
    __slice = [].slice,
  ...
  exports.Compiler = (function() {
    function Compiler(state, trail, catches, exits, continues, purememo, memo) {
      var solver;
    ...
    Compiler.prototype.fake = function() {
      var result, state;
    ...
    Compiler.prototype.restore = function(faked) {
    ...
    Compiler.prototype.cont = function(exp, cont) {
      ...
      expCont = (exp != null ? exp.cont : void 0) != null;
      if (expCont) {
        return exp.call(this, cont);
      } else {
        if (_.isNumber) {
          return clamda(function(v) {
            return exp;
          });
        }
      }
    ...
    Compiler.prototype.appendFailcont = function(fun) {
      var fc, state, trail;
    ...
    Compiler.prototype.pushCatch = function(value, cont) {
    ...
    Compiler.prototype.popCatch = function(value) {
      var catches;
    ...
    Compiler.prototype.findCatch = function(value) {
      var catches;
    ...
    Compiler.prototype.protect = function(fun) {
      return fun;
    };
  ...
  Clamda = (function() {
    ...
    Clamda.prototype.toCode = function(compiler) {
      return "function(" + v + ") {" + (compiler.toCode(this.body)) + "}";
    };
