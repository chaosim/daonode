...
(function() {
  var ArgumentError, ArityError, Compiler, Env, Error, TypeError, augmentOperators, beautify, compile, fs, hasOwnProperty, il, prelude, _, _ref, _ref1, _ref2,
    __slice = [].slice,
  ...
  prelude = [il.globalassign('_', il.require('underscore')), il.globalassign('__slice', il.attr([], il.symbol('slice'))), il.globalassign('solve', il.attr(il.require('f:/daonode/lib/compiler/core.js'), il.symbol('solve'))), il.globalassign('parser', il.require('f:/daonode/lib/compiler/parser.js')), il.globalassign('solvecore', il.require('f:/daonode/lib/compiler/solve.js')), il.globalassign('SolverFinish', il.attr(il.vari('solvecore'), il.symbol('SolverFinish'))), il.globalassign('Solver', il.attr(il.vari('solvecore'), il.symbol('Solver'))), il.globalassign('Trail', il.attr(il.vari('solvecore'), il.symbol('Trail'))), il.globalassign('Var', il.attr(il.vari('solvecore'), il.symbol('Var'))), il.globalassign('DummyVar', il.attr(il.vari('solvecore'), il.symbol('DummyVar')))];
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      exps = __slice.call(prelude);
      exps.push(il.assign(il.attr(il.global('exports'), il.symbol('main')), il.lamda([], il.assign(il.solver, il["new"](il.symbol('Solver').call())), il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, il.clamda(v, il["throw"](il["new"](il.symbol('SolverFinish').call(v))))), il.assign(il.cutcont, il.failcont), il.run(il.clamda(v, exp)))));
      exp = il.topbegin.apply(il, exps).optimize(new Env(), this);
      exp = exp.jsify();
      return exp.toCode(this);
    };

    Compiler.prototype.il_vari = function(name) {
      return il.vari(name + '_$' + this.index++);
    };
    ...
    Compiler.prototype.leftValueCont = function(cont, task, item, exp, op) {
      var cont1, fc, head, i, index, length, obj, object, v;
      ...
      if (_.isString(item)) {
        ...
        switch (task) {
          case 'assign':
            return this.cont(exp, this.clamda(v, il.assign(item, v), cont.call(v)));
          case 'augment-assign':
            return this.cont(exp, this.clamda(v, new augmentOperators[op](item, v), cont.call(v)));
          case 'incp':
            fc = this.il_vari('fc');
      ...
      if (head === "index") {
        object = item[1];
        index = item[2];
        obj = this.il_vari('obj');
        i = this.il_vari('i');
        v = this.il_vari('v');
        item = il.index(obj, i);
        switch (task) {
          case 'assign':
            cont1 = this.cont(exp, this.clamda(v, il.assign(item, v), cont.call(v)));
            break;
          case 'augment-assign':
            cont1 = this.cont(exp, this.clamda(v, new augmentOperators[op](item, v), cont.call(v)));
            break;
          case 'incp':
            fc = this.il_vari('fc');
    ...
    Compiler.prototype.specials = {
      ...
      "lambda": function() {
        ...
        cont = cont.call(il.lamda(params, this.expsCont(body, this.clamda(v, v))));
      ...
      "macro": function() {
        ...
        globalCont = this.globalCont;
        cont = cont.call(il.lamda(params1, this.expsCont(body, this.clamda(v, v))));
        this.globalCont = globalCont;
        return cont;
      },
      ...
      "funcall": function() {
        ...
        params = (function() {
          ...
          for (i = _i = 0; 0 <= length ? _i < length : _i > length; i = 0 <= length ? ++_i : --_i) {
            _results.push(this.il_vari('a' + i));
          }
          return _results;
        }).call(this);
      ...
      'block': function() {
        ...
        f = this.il_vari('block' + label);
        fun = il.clamda(this.il_vari('v'), null);
        continues.push(f);
      ...
      'catch': function() {
        ...
        v = this.il_vari('v');
        v2 = this.il_vari('v2');
        return this.cont(tag, this.clamda(v, il.pushCatch(v, cont), this.expsCont(forms, this.clamda(v2, il.popCatch(v), cont.call(v2)))));
      },
      "throw": function(cont, tag, form) {
        ...
        v = this.il_vari('v');
        v2 = this.il_vari('v');
        return this.cont(tag, this.clamda(v, this.cont(form, this.clamda(v2, this.protect(il.findCatch(v)).call(v2)))));
      },
      'unwind-protect': function() {
        ...
        compiler = this;
        this.protect = function(cont) {
          return compiler.clamda(v1, compiler.expsCont(cleanup, compiler.clamda(v2, oldprotect(cont).call(v1))));
        };
        result = this.cont(form, compiler.clamda(v1, this.expsCont(cleanup, this.clamda(v2, cont.call(v1)))));
      ...
      'pushp': function(cont, list, value) {
        var fc, list1, v, value1;

        list1 = this.il_vari('list');
        value1 = this.il_vari('value');
        fc = this.il_vari('fc');
        v = this.il_vari('v');
        return this.cont(list, this.clamda(list1, this.cont(value, this.clamda(value1, il.begin(il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.pop(list1), fc.call(v))), il.push(list1, value1), cont.call(value1))))));
      },
      'orp': function(cont, x, y) {
        var fc, state, trail, v;

        v = this.il_vari('v');
        trail = this.il_vari('trail');
        state = this.il_vari('state');
        fc = this.il_vari('fc');
        return il.begin(il.assign(trail, il.trail), il.assign(state, il.state), il.assign(fc, il.failcont), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), this.cont(y, cont))), this.cont(x, cont));
      },
      'ifp': function(cont, test, action) {
        ...
        v = this.il_vari('v');
        fc = this.il_vari('fc');
        return il.begin(il.assign(fc, il.failcont), this.cont(test, this.clamda(v, il.setfailcont(fc), this.cont(action, cont))));
      },
      'notp': function(cont, goal) {
        ...
        state = this.il_vari('state');
        fc = this.il_vari('fc');
        return il.begin(il.assign(trail, il.trail), il.assign(fc, il.failcont), il.assign(state, il.state), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(v))), this.cont(goal, fc));
      },
      ...
      'cutable': function(cont, goal) {
        ...
        cc = this.il_vari('cutcont');
        v = this.il_vari('v');
        return il.begin(il.assign(cc, il.cutcont), il.assign(il.cutcont, il.failcont), this.cont(goal, this.clamda(v, il.setcutcont(cc), cont.call(v))));
      },
      'cut': function(cont) {
      ...
      'findall': function(cont, goal, result, template) {
        ...
        v = this.il_vari('v');
        if (result == null) {
          return il.begin(il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.setfailcont(fc), cont.call(v))), this.cont(goal, il.failcont));
        } else {
          result1 = this.il_vari('result');
          return il.begin(il.assign(result1, []), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.if_(il.unify(result, result1), fc.call(v), il.begin(il.setfailcont(fc), cont.call(v))))), this.cont(exp, this.clamda(v, il.push(result1, il.getvalue(template)), il.failcont.call(v))));
        }
      },
      'once': function(cont, goal) {
        ...
        fc = this.il_vari('fc');
        v = this.il_vari('v');
        return il.begin(il.assign(fc, il.failcont), this.cont(goal, this.clamda(v, il.setfailcont(fc), cont.call(v))));
      },
      'parse': function(cont, exp, state) {
        var oldState, v;

        v = this.il_vari('v');
        oldState = this.il_vari('state');
        return this.cont(state, this.clamda(v, il.begin(il.assign(oldState, il.state), il.setstate(v), this.cont(exp, this.clamda(v, il.setstate(oldState), cont.call(v))))));
      },
      'parsetext': function(cont, exp, text) {
        ...
        v = this.il_vari('v');
        oldState = this.il_vari('state');
        return this.cont(text, this.clamda(v, il.begin(il.assign(oldState, il.state), il.setstate(il.array(v, 0)), this.cont(exp, this.clamda(v, il.setstate(oldState), cont.call(v))))));
      },
      'setstate': function(cont, state) {
        var v;

        v = this.il_vari('v');
        return this.cont(state, this.clamda(v, il.setstate(v), cont.call(v)));
      },
      'settext': function(cont, text) {
        var v;

        v = this.il_vari('v');
        return this.cont(text, this.clamda(v, il.setstate(il.array(v, 0)), cont.call(v)));
      },
      'setpos': function(cont, pos) {
        var v;

        v = this.il_vari('v');
        return this.cont(pos, this.clamda(v, il.assign(il.index(il.state, 1), v), cont.call(v)));
      },
      ...
      'eoi': function(cont) {
        ...
        data = this.il_vari('data');
        pos = this.il_vari('pos');
      ...
      'subtext': function(cont, length, start) {
        ...
        text = this.il_vari('text');
        pos = this.il_vari('pos');
        start1 = this.il_vari('start');
        length1 = this.il_vari('length');
        return il.begin(il.listassign(text, pos, il.state), il.begin(il.assign(start1, il.if_(il.ne(start, null), start, pos)), il.assign(length1, il.if_(il.ne(length, null), length, il.length(text))), cont.call(il.slice(text, start1, il.add(start1, length1)))));
      },
      ...
      'lazymay': function(cont, exp) {
        ...
        fc = this.il_vari('fc');
        v = this.il_vari('v');
        return il.begin(il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.setfailcont(fc), this.cont(exp, cont))), cont.call(null));
      },
      'greedymay': function(cont, exp) {
        ...
        fc = this.il_vari('fc');
        v = this.il_vari('v');
        return il.begin(il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.setfailcont(fc), cont.call(v))), this.cont(exp, this.clamda(v, il.setfailcont(fc), cont.call(v))));
      },
      'any': function(cont, exp) {
        ...
        trail = this.il_vari('trail');
        state = this.il_vari('state');
        anyCont = this.il_vari('anyCont');
        v = this.il_vari('v');
        return il.begin(il.assign(anyCont, il.clamda(v, il.begin(il.assign(fc, il.failcont), il.assign(trail, il.trail), il.assign(state, il.state), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(v))), this.cont(exp, anyCont)))), anyCont.call(null));
      },
      'lazyany': function(cont, exp) {
        ...
        v = this.il_vari('v');
        anyCont = this.il_vari('anyCont');
        anyFcont = this.il_vari('anyFcont');
        return il.begin(il.assign(anyCont, il.clamda(v, il.assign(trail, il.trail), il.settrail(il.newTrail), il.setfailcont(anyFcont), cont.call(v))), il.assign(anyFcont, il.clamda(v, il.undotrail(il.trail), il.settrail(trail), il.setfailcont(fc), this.cont(exp, anyCont))), il.assign(fc, il.failcont), anyCont.call(null));
      },
      ...
      'parallel': function(cont, x, y, checkFunction) {
        ...
        state = this.il_vari('state');
        right = this.il_vari('right');
        v = this.il_vari('v');
        return il.begin(il.assign(state, il.state), this.cont(x, this.clamda(v, il.assign(right, il.state), il.setstate(state), this.cont(y, this.clamda(v, il.if_(il.fun(checkFunction).call(il.state, right), cont.call(v), il.failcont.call(false)))))));
      },
      'follow': function(cont, item) {
        ...
        v = this.il_vari('v');
        state = this.il_vari('state');
        return il.begin(il.assign(state, il.state), this.cont(item, this.clamda(v, il.setstate(state), cont.call(v))));
      },
      'notfollow': function(cont, item) {
        ...
        fc = this.il_vari('fc');
        v = this.il_vari('v');
        return il.begin(il.assign(fc, il.failcont), il.assign(state, il.state), il.setfailcont(cont), this.cont(item, this.clamda(v, il.setstate(state), fc.call(v))));
      },
    ...
    Compiler.prototype.expsCont = function(exps, cont) {
      ...
      if (length === 0) {
        ...
        v = this.il_vari('v');
        return this.cont(exps[0], this.clamda(v, this.expsCont(exps.slice(1), cont)));
      }
    };
    ...
    Compiler.prototype.quasiquote = function(exp, cont) {
      ...
      if (head === "unquote") {
        ...
        quasilist = this.il_vari('quasilist');
        v = this.il_vari('v');
