  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'orp': function(cont, x, y) {
        ...
        state = il.vari('state');
        fc = il.vari('fc');
        return il.begin(il.assign(oldTrail, il.trail), il.assign(trail, il.newTrail), il.settrail(trail), il.assign(state, il.state), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.undotrail.call(trail), il.settrail(oldTrail), il.setstate(state), il.setfailcont(fc), this.cont(y, cont))), this.cont(x, cont));
      }
    };
