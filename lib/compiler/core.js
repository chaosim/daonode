  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'parsetext': function(cont, exp, text) {
        ...
        v1 = this.newconst('v');
        oldState = this.newconst('state');
        return this.cont(text, this.clamda(v, il.begin(il.assign(oldState, il.state), il.setstate(il.array(v, 0)), this.cont(exp, this.clamda(v, il.paramassign(v1, v), il.setstate(oldState), cont.call(v1))))));
      },
