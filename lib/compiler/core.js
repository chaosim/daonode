  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'unwind-protect': function() {
        ...
        compiler = this;
        this.protect = function(cont) {
          return compiler.clamda(v1, il.assign(temp, v1), compiler.expsCont(cleanup, compiler.clamda(v2, oldprotect(cont).call(temp))));
        };
        result = this.cont(form, compiler.clamda(v1, il.assign(temp, v1), this.expsCont(cleanup, this.clamda(v2, cont.call(temp)))));
