  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.leftValueCont = function(cont, task, item, exp, op) {
      ...
      if (_.isString(item)) {
        ...
        switch (task) {
          case 'assign':
            return this.cont(exp, this.clamda(v, il.assign(item, v), cont.call(item)));
          case 'augment-assign':
            return this.cont(exp, this.clamda(v, new augmentOperators[op](item, v), cont.call(item)));
          case 'incp':
            fc = this.il_vari('fc');
      ...
      if (head === "index") {
        ...
        switch (task) {
          case 'assign':
            cont1 = this.cont(exp, this.clamda(v, il.assign(item, v), cont.call(item)));
            break;
          case 'augment-assign':
            cont1 = this.cont(exp, this.clamda(v, new augmentOperators[op](item, v), cont.call(item)));
            break;
          case 'incp':
            fc = this.il_vari('fc');
    ...
    Compiler.prototype.specials = {
      ...
      "lambda": function() {
        ...
        cont = cont.call(il.lamda(params, this.expsCont(body, il.idcont)));
      ...
      'catch': function() {
        var cont, forms, tag, temp, v, v2;

        cont = arguments[0], tag = arguments[1], forms = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
        v = this.il_vari('v');
        v2 = this.il_vari('v');
        temp = this.il_vari('temp');
        return this.cont(tag, this.clamda(v, il.assign(temp, v), il.pushCatch(temp, cont), this.expsCont(forms, this.clamda(v2, il.popCatch(temp), cont.call(v2)))));
      },
      "throw": function(cont, tag, form) {
        ...
        v2 = this.il_vari('v');
        temp = this.il_vari('temp');
        return this.cont(tag, this.clamda(v, il.assign(temp, v), this.cont(form, this.clamda(v2, this.protect(il.findCatch(temp)).call(v2)))));
      },
      'unwind-protect': function() {
        var cleanup, compiler, cont, form, oldprotect, result, temp, v1, v2;
        ...
        compiler = this;
        this.protect = function(cont) {
          return compiler.clamda(v1, il.assign(temp, v), compiler.expsCont(cleanup, compiler.clamda(v2, oldprotect(cont).call(temp))));
        };
        result = this.cont(form, compiler.clamda(v1, il.assign(temp, v), this.expsCont(cleanup, this.clamda(v2, cont.call(temp)))));
      ...
      'pushp': function(cont, list, value) {
        ...
        v = this.il_vari('v');
        temp = this.il_vari('temp');
        return this.cont(list, this.clamda(list1, il.assign(temp, list1), this.cont(value, this.clamda(value1, il.begin(il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.pop(temp), fc.call(v))), il.push(temp, value1), cont.call(value1))))));
      },
      ...
      'subtext': function(cont, length, start) {
        ...
        start2 = this.il_vari('start');
        length2 = this.il_vari('length');
        start3 = this.il_vari('start');
        length3 = this.il_vari('length');
      ...
      'any': function(cont, exp) {
        ...
        v = this.il_vari('v');
        return il.begin(il.assign(anyCont, il.recclamda(v, il.begin(il.assign(fc, il.failcont), il.assign(trail, il.trail), il.assign(state, il.state), il.settrail(il.newTrail), il.setfailcont(il.clamda(v, il.undotrail(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(v))), this.cont(exp, anyCont)))), anyCont.call(null));
      },
      'lazyany': function(cont, exp) {
        ...
        return il.begin(il.assign(anyCont, il.recclamda(v, il.assign(trail, il.trail), il.settrail(il.newTrail), il.setfailcont(anyFcont), cont.call(null))), il.assign(anyFcont, il.recclamda(v, il.undotrail(il.trail), il.settrail(trail), il.setfailcont(fc), this.cont(exp, anyCont))), il.assign(fc, il.failcont), anyCont.call(null));
      },
      'greedyany': function(cont, exp) {
        ...
        anyCont = this.il_vari('anyCont');
        v = this.il_vari('v');
        return il.begin(il.assign(anyCont, il.recclamda(v, this.cont(exp, anyCont))), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.setfailcont(fc), cont.call(v))), anyCont.call(null));
      },
      'parallel': function(cont, x, y, checkFunction) {
        ...
        v = this.il_vari('v');
        return il.begin(il.assign(state, il.state), this.cont(x, this.clamda(v, v, il.assign(right, il.state), il.setstate(state), this.cont(y, this.clamda(v, il.if_(il.fun(checkFunction).call(il.state, right), cont.call(v), il.failcont.call(v)))))));
      },
      'follow': function(cont, item) {
        ...
        v = this.il_vari('v');
        state = this.il_vari('state');
        return il.begin(il.assign(state, il.state), this.cont(item, clamda(v, il.setstate(state), cont.call(v))));
      },
