...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      fromCont = this.cont(exp, this.globalCont);
    ...
    Compiler.prototype.leftValueCont = function(cont, op, item, exp) {
      ...
      if (head === "index") {
        ...
        return this.cont(object, this.clamda(obj, this.cont(index, this.clamda(i, cont1))));
      } else {
    ...
    Compiler.prototype.specials = {
      ...
      "jsfun": function(cont, func) {
        ...
        return this.cont(func, this.clamda(v, cont.call(f)));
      },
      ...
      "macall": function() {
        ...
        for (i = _i = _ref = length - 1; _i >= 0; i = _i += -1) {
          cont = (function(i, cont) {
            return compiler.clamda(params[i], cont).call(il.lamda([], compiler.cont(args[i], il.clamda(v, v))));
          })(i, cont);
        }
        return this.cont(caller, this.clamda(f, cont));
      },
