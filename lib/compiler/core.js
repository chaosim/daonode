  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'cutable': function(cont, goal) {
        ...
        cc = il.vari('cutcont');
        v = il.vari('v');
        return il.begin(il.assign(cc, il.cutcont), il.assign(il.cutcont, il.failcont), this.cont(goal, this.clamda(v, il.assign(il.cutcont, cc), cont.call(v))));
      },
      'cut': function(cont) {
      ...
      'parse': function(cont, exp, state) {
        ...
        return this.cont(state, this.clamda(v, il.assign(oldState, il.state), il.setstate(v), this.cont(exp, this.clamda(v, il.setstate(oldState), cont.call(v)))));
      },
      'parsetext': function(cont, exp, text) {
        ...
        v = il.vari('v');
        oldState = il.vari('state');
        return this.cont(text, this.clamda(v, il.assign(oldState, il.state), il.setstate(il.array(v, 0)), this.cont(exp, this.clamda(v, il.setstate(oldState), cont.call(v)))));
      },
