...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      exps = [il.globalassign('_', il.require('underscore')), il.globalassign('__slice', il.attr([], il.symbol('slice'))), il.globalassign('solve', il.attr(il.require('f:/daonode/lib/compiler/core.js'), il.symbol('solve'))), il.globalassign('parser', il.require('f:/daonode/lib/compiler/parser.js')), il.globalassign('solvecore', il.require('f:/daonode/lib/compiler/solve.js')), il.globalassign('SolverFinish', il.attr(il.vari('solvecore'), il.symbol('SolverFinish'))), il.globalassign('Solver', il.attr(il.vari('solvecore'), il.symbol('Solver'))), il.globalassign('Trail', il.attr(il.vari('solvecore'), il.symbol('Trail'))), il.globalassign('Var', il.attr(il.vari('solvecore'), il.symbol('Var'))), il.globalassign('DummyVar', il.attr(il.vari('solvecore'), il.symbol('DummyVar'))), il.globalassign(il.solver, il["new"](il.symbol('Solver').call())), il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, il.clamda(v, il["throw"](il["new"](il.symbol('SolverFinish').call(v))))), il.assign(il.cutcont, il.failcont), il.run(il.clamda(v, exp))];
      exp = il.assign(il.attr(il.global('exports'), il.symbol('main')), il.lamda.apply(il, [[]].concat(__slice.call(exps))));
      exp = exp.optimize(new Env(null, {}, {}, {}), this);
      exp = exp.jsify();
    ...
    Compiler.prototype.specials = {
      ...
      'lazyany': function(cont, exp) {
        ...
        return il.begin(il.local(trail), il.assign(anyCont, il.recclamda(v, il.globalassign(trail, il.trail), il.settrail(il.newTrail), il.setfailcont(anyFcont), cont.call(null))), il.assign(anyFcont, il.recclamda(v, il.undotrail(il.trail), il.settrail(trail), il.setfailcont(fc), this.cont(exp, anyCont))), il.assign(fc, il.failcont), anyCont.call(null));
      },
  ...
  exports.Env = Env = (function() {
    function Env(outer, bindings, _locals, _globals) {
    ...
    Env.prototype.extend = function(vari, value, locals, globals) {
      var bindings;

      bindings = {};
      bindings[vari.name] = value;
      return new Env(this, bindings, locals, globals);
    };

    Env.prototype.extendBindings = function(bindings, locals, globals) {
      return new Env(this, bindings, locals, globals);
    };
    ...
    Env.prototype.globals = function() {
      return this._globals || this.outer.globals();
    };
