  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'unify': function(cont, x, y) {
        ...
        x1 = il.vari('x');
        y1 = il.vari('y');
        return this.cont(x, il.clamda(x1, this.cont(y, il.clamda(y1, il.if_(il.unify.call(x1, y1), cont.call(true), il.failcont.call(false))))));
      },
      'notunify': function(cont, x, y) {
        ...
        x1 = il.vari('x');
        y1 = il.vari('y');
        return this.cont(x, il.clamda(x1, this.cont(y, il.clamda(y1, il.if_(il.unify.call(x, y), il.failcont.call(false), cont.call(true))))));
      },
      ...
      'orp': function(cont, x, y) {
        ...
        state = il.vari('state');
        fc = il.vari('fc');
        return il.begin(il.assign(trail, il.trail), il.settrail(il.newTrail), il.assign(state, il.state), il.assign(fc, il.failcont), il.setfailcont(il.clamda(v, il.undotrail.call(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), this.cont(y, cont))), this.cont(x, cont));
      },
      'notp': function(cont, goal) {
        ...
        state = il.vari('state');
        fc = il.vari('fc');
        return il.begin(il.assign(trail, il.trail), il.settrail(il.newTrail), il.assign(fc, il.failcont), il.assign(state, il.state), il.setfailcont(il.clamda(v, il.undotrail.call(il.trail), il.settrail(trail), il.setstate(state), il.setfailcont(fc), cont.call(v))), this.cont(goal, fc));
      },
