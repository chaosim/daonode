...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      "if": function(cont, test, clauses, else_) {
        var v;

        v = this.newvar('v');
        return this.cont(test, this.clamda(v, il.switch_(v, this.cont(then_, cont), this.cont(else_, cont))));
      },
      ...
      'block': function() {
        ...
        f = this.newvar(il.blockvar('block' + label));
        f.isRecursive = true;
