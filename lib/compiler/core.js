...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      this.env = new CpsEnv(null, {});
      v = this.newconst('v');
      done = this.clamda(v, il["throw"](il["new"](il.symbol('SolverFinish').call(v))));
      exps = [il.assign(il.uservar('_'), il.require('underscore')), il.assign(il.uservar('__slice'), il.attr([], il.symbol('slice'))), il.assign(il.uservar('solve'), il.attr(il.require('../core.js'), il.symbol('solve'))), il.assign(il.uservar('parser'), il.require('../parser.js')), il.assign(il.uservar('solvecore'), il.require('../solve.js')), il.assign(il.uservar('SolverFinish'), il.attr(il.uservar('solvecore'), il.symbol('SolverFinish'))), il.assign(il.uservar('Solver'), il.attr(il.uservar('solvecore'), il.symbol('Solver'))), il.assign(il.uservar('Trail'), il.attr(il.uservar('solvecore'), il.symbol('Trail'))), il.assign(il.uservar('Var'), il.attr(il.uservar('solvecore'), il.symbol('Var'))), il.assign(il.uservar('DummyVar'), il.attr(il.uservar('solvecore'), il.symbol('DummyVar'))), il.assign(il.uservar('solver'), il["new"](il.symbol('Solver').call())), il.assign(il.uservar('UArray'), il.attr(il.uservar('solvecore'), il.symbol('UArray'))), il.assign(il.uservar('Cons'), il.attr(il.uservar('solvecore'), il.symbol('Cons'))), il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, done), il.assign(il.cutcont, il.failcont), il.run(il.transparentuserlamda([], this.cont(exp, done)))];
    ...
    Compiler.prototype.uniquevar = function(name, index) {
      return this.env.uniquevar(il.uservar(name), index);
    };

    Compiler.prototype.uniqueconst = function(name, index) {
      return this.env.uniqueconst(il.uservar(name), index);
    };
    ...
    Compiler.prototype.cont = function(exp, cont) {
      ...
      if (_.isString(exp)) {
        return cont.call(this.getvar(exp));
      }
      if (!_.isArray(exp)) {
    ...
    Compiler.prototype.leftValueCont = function(cont, task, item, exp, op) {
      ...
      if (_.isString(item)) {
        return assignExpCont(this.getvar(item));
      }
      if (!_.isArray(item)) {
      ...
      if (head === "index") {
        ...
        return assignExpCont(this.uniquevar(item[1], item[2]));
      } else if (head === 'uniqueconst') {
        return assignExpCont(this.uniqueconst(item[1], item[2]));
      } else {
    ...
    Compiler.prototype.specials = {
      ...
      "nonlocal": function() {
        ...
        vars = (function() {
          ...
          for (_i = 0, _len = vars.length; _i < _len; _i++) {
            name = vars[_i];
            _results.push(this.getvar(name));
          }
          return _results;
        }).call(this);
      ...
      "uniquevar": function(cont, name, index) {
        return cont.call(this.uniquevar(name, index));
      },
      "uniqueconst": function(cont, name, index) {
        return cont.call(this.uniqueconst(name, index));
      },
      ...
      "macro": function() {
        var body, cont, globalCont, i, p, params, params1;
      ...
      "evalarg": function(cont, name) {
        return cont.call(this.getvar(name).call());
      },
      "array": function() {
        var args, compiler, cont, i, length, xs, _i, _ref, _results;
        ...
        for (i = _i = _ref = length - 1; _i >= 0; i = _i += -1) {
          _results.push(cont = (function(i, cont) {
  ...
  CpsEnv = (function(_super) {
    ...
    CpsEnv.prototype.uniquevar = function(name, index) {
      var e, uniquename, v;

      uniquename = '@' + name + index;
      try {
        return v = this.lookup(uniquename);
      } catch (_error) {
        e = _error;
        if (e instanceof VarLookupError) {
          this.bindings[uniquename] = v = this.newvar(name);
          return v;
        }
      }
    };

    CpsEnv.prototype.uniqueconst = function(name, index) {
      var e, uniquename, v;
      ...
      try {
        ...
        e = _error;
        if (e instanceof VarLookupError) {
          this.bindings[uniquename] = v = this.newconst(name);
          return v;
        }
      }
    };
