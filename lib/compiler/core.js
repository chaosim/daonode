  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      'lazyany': function(cont, exp) {
        var anyCont, anyFcont, fc, v;

        fc = il.vari('fc');
        v = il.vari('v');
        anyCont = il.vari('anyCont');
        anyFcont = il.vari('anyFcont');
        return il.begin(il.assign(anyCont, il.clamda(v, il.setfailcont(anyFcont), cont.call(v))), il.assign(anyFcont, il.clamda(v, il.setfailcont(fc), this.cont(exp, anyCont))), il.assign(fc, il.failcont), anyCont.call(v));
      },
