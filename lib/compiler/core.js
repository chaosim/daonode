...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      exps = [il.usernonlocalassign('_', il.require('underscore')), il.usernonlocalassign('__slice', il.attr([], il.symbol('slice'))), il.usernonlocalassign('solve', il.attr(il.require('f:/daonode/lib/compiler/core.js'), il.symbol('solve'))), il.usernonlocalassign('parser', il.require('f:/daonode/lib/compiler/parser.js')), il.usernonlocalassign('solvecore', il.require('f:/daonode/lib/compiler/solve.js')), il.usernonlocalassign('SolverFinish', il.attr(il.usernonlocal('solvecore'), il.symbol('SolverFinish'))), il.usernonlocalassign('Solver', il.attr(il.usernonlocal('solvecore'), il.symbol('Solver'))), il.usernonlocalassign('Trail', il.attr(il.usernonlocal('solvecore'), il.symbol('Trail'))), il.usernonlocalassign('Var', il.attr(il.usernonlocal('solvecore'), il.symbol('Var'))), il.usernonlocalassign('DummyVar', il.attr(il.usernonlocal('solvecore'), il.symbol('DummyVar'))), il.usernonlocalassign(il.solver, il["new"](il.symbol('Solver').call())), il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, il.clamda(v, il["throw"](il["new"](il.symbol('SolverFinish').call(v))))), il.assign(il.cutcont, il.failcont), il.run(il.clamda(v, exp))];
      lamda = il.lamda.apply(il, [[]].concat(__slice.call(exps)));
