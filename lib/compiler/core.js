...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.specials = {
      ...
      "evalarg": function(cont, name) {
        return cont.call(this.getvar(name).call(cont));
      },
      "funcall": function() {
        ...
        params = (function() {
          ...
          for (i = _i = 0; 0 <= length ? _i < length : _i > length; i = 0 <= length ? ++_i : --_i) {
            _results.push(this.newvar('arg' + i));
          }
          return _results;
        }).call(this);
      ...
      'block': function() {
        ...
        f = this.newvar('block' + label);
        f.isRecursive = true;
        fun = il.clamda(this.newvar('v'), null);
        continues.push(f);
      ...
      'catch': function() {
        ...
        v = this.newvar('v');
        v2 = this.newvar('v');
        temp1 = this.newvar('temp');
        temp2 = this.newvar('temp');
      ...
      'pushp': function(cont, list, value) {
        ...
        list1 = this.newvar('list');
        value1 = this.newvar('value');
        list2 = this.newvar('list');
        value2 = this.newvar('value');
        fc = this.newvar('fc');
        v = this.newvar('v');
      ...
      'orp': function(cont, x, y) {
        ...
        v = this.newvar('v');
        trail = this.newvar('trail');
        state = this.newvar('state');
        fc = this.newvar('fc');
      ...
      'subtext': function(cont, length, start) {
        ...
        text = this.newvar('text');
        pos = this.newvar('pos');
        start1 = this.newvar('start');
        length1 = this.newvar('length');
        start2 = this.newvar('start');
        length2 = this.newvar('length');
        start3 = this.newvar('start');
        length3 = this.newvar('length');
    ...
    CpsEnv.prototype.getvar = function(vari) {
      ...
      try {
        ...
        if (e instanceof VarLookupError) {
          this.bindings[vari] = v = this.newvar(vari);
          return v;
        }
      }
    };
  ...
  exports.OptimizationEnv = OptimizationEnv = (function(_super) {
    ...
    function OptimizationEnv(outer, bindings, lamda, userlamda) {
      this.outer = outer;
      this.bindings = bindings;
      this.lamda = lamda;
      if (userlamda) {
        this.userlamda = userlamda;
      } else {
        while (outer) {
          if (outer.userlamda) {
    ...
    OptimizationEnv.prototype.extendBindings = function(bindings, lamda, userlamda) {
      return new OptimizationEnv(this, bindings, lamda, userlamda);
    };
