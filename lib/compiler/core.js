...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.prototype.compile = function(exp) {
      ...
      f = il.begin(il.assign(il.state, null), il.assign(il.catches, {}), il.assign(il.trail, il.newTrail), il.assign(il.failcont, il.clamda(v, v)), il.assign(il.cutcont, il.failcont), il.assign(il.vari('exports.main'), il.clamda(v, fromCont)));
      f.refMap = {};
