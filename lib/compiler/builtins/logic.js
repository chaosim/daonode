...
(function() {
  var ArgumentError, Trail, Var, andp, binaryPredicate, callfc, core, findall1, findall2, macro, notunifyFun, notunifyList, notunifyListFun, orp, orpFun, runner, special, unaryPredicate, unifyFun, unifyList, unifyListFun,
    __slice = [].slice;
  ...
  exports.callablep = special(1, 'callablep', function(solver, cont, x) {
    return solver.cont(x, function(x1) {}, x1 instanceof core.Apply ? cont(true) : solver.failcont(false));
  });
