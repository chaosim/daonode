...
(function() {
  var Cons, DummyVar, Error, Trail, TypeError, UArray, UObject, Var, uarray, _, _ref,
  ...
  exports.$pushCatch = function(catches, value, cont) {
    var _ref;

    catches = (_ref = catches[value]) != null ? _ref : catches[value] = [];
    return catches.push(cont);
  };

  exports.$popCatch = function(catches, value) {
  ...
  exports.$findCatch = function(catches, value) {
    catches = catches[value];
