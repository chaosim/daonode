...
(function() {
  var add, andp, assign, begin, core, eq, fail, funcall, if_, inc, lamda, le, logicvar, macro, not_, notp, orp, print_, solve, solvebase, succeed, unify, vari, xexports, _, _ref;
  ...
  _ref = require('../util'), begin = _ref.begin, assign = _ref.assign, print_ = _ref.print_, funcall = _ref.funcall, lamda = _ref.lamda, macro = _ref.macro, if_ = _ref.if_, add = _ref.add, eq = _ref.eq, le = _ref.le, inc = _ref.inc, not_ = _ref.not_, logicvar = _ref.logicvar, unify = _ref.unify, succeed = _ref.succeed, fail = _ref.fail, andp = _ref.andp, orp = _ref.orp, notp = _ref.notp;
