...
(function() {
  var add, andp, array, assign, begin, core, cut, cutable, eq, fail, findall, funcall, getvalue, if_, inc, lamda, le, logicvar, macro, not_, notp, once, orp, print_, solve, solvebase, succeed, uarray, unify, vari, xexports, _, _ref;
  ...
  exports.Test = {
    ...
    "test unify array": function(test) {
      var $a, a;
