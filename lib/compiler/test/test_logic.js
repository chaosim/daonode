...
(function() {
  var add, andp, assign, begin, core, cut, cutable, eq, fail, findall, funcall, getvalue, if_, inc, lamda, le, logicvar, macro, not_, notp, once, orp, print_, solve, solvebase, succeed, unify, vari, xexports, _, _ref;
