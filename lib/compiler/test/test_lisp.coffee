...
#    test.equal  solve(block(a, 2, 1)), 1
#    test.equal  solve(block(a, print_(1), 1)), 1
...
#    test.equal  solve(block(a, block(b, break_(a, 2), 1), 3)), 2
#    x = vari('x')
