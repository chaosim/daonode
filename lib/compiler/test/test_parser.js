...
(function() {
  var Error, add, andp, any, assign, begin, boi, bol, char, core, dummy, eoi, eol, eq, findall, funcall, getpos, getstate, gettext, greedyany, greedymay, if_, inc, jsfun, lamda, lazyany, lazymay, lefttext, literal, logicvar, macall, macro, may, number, parsetext, print_, quote, settext, solve, step, string, subtext, suffixinc, vari, xexports, _ref, _ref1;

  _ref = core = require('../core'), solve = _ref.solve, Error = _ref.Error;

  _ref1 = require('../util'), string = _ref1.string, begin = _ref1.begin, quote = _ref1.quote, assign = _ref1.assign, print_ = _ref1.print_, funcall = _ref1.funcall, macall = _ref1.macall, lamda = _ref1.lamda, macro = _ref1.macro, jsfun = _ref1.jsfun, if_ = _ref1.if_, add = _ref1.add, eq = _ref1.eq, inc = _ref1.inc, suffixinc = _ref1.suffixinc, logicvar = _ref1.logicvar, dummy = _ref1.dummy, andp = _ref1.andp, findall = _ref1.findall, getstate = _ref1.getstate, gettext = _ref1.gettext, getpos = _ref1.getpos, eoi = _ref1.eoi, boi = _ref1.boi, eol = _ref1.eol, bol = _ref1.bol, step = _ref1.step, lefttext = _ref1.lefttext, subtext = _ref1.subtext, parsetext = _ref1.parsetext, char = _ref1.char, settext = _ref1.settext, number = _ref1.number, literal = _ref1.literal, may = _ref1.may, greedymay = _ref1.greedymay, lazymay = _ref1.lazymay, any = _ref1.any, lazyany = _ref1.lazyany, greedyany = _ref1.greedyany;
  ...
  xexports.Test = {
    ...
    "test seplist": function(test) {
      ...
      test.deepEqual(solve(begin(parsetext(andp(seplist(char(_), {
        ...
        result: result,
        template: _
      }), char(','), char(string('b')), char(','), char('c')), 'a,b,c'), result)), ['a']);
      test.equal(core.status, core.SUCCESS);
      return test.done();
    },
