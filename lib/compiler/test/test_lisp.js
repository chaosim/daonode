...
(function() {
  ...
  _ref = require('../util'), string = _ref.string, begin = _ref.begin, quote = _ref.quote, assign = _ref.assign, print_ = _ref.print_, jsobject = _ref.jsobject, variable = _ref.variable, funcall = _ref.funcall, macall = _ref.macall, lamda = _ref.lamda, macro = _ref.macro, jsfun = _ref.jsfun, if_ = _ref.if_, add = _ref.add, eq = _ref.eq, le = _ref.le, inc = _ref.inc, suffixinc = _ref.suffixinc, print_ = _ref.print_, loop_ = _ref.loop_, until_ = _ref.until_, while_ = _ref.while_, not_ = _ref.not_, dec = _ref.dec, eval_ = _ref.eval_, qq = _ref.qq, uq = _ref.uq, uqs = _ref.uqs, iff = _ref.iff, block = _ref.block, break_ = _ref.break_, continue_ = _ref.continue_, makeLabel = _ref.makeLabel, catch_ = _ref.catch_, throw_ = _ref.throw_, protect = _ref.protect, callcc = _ref.callcc;
