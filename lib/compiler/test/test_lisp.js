...
(function() {
  var add, assign, begin, block, break_, callcc, catch_, continue_, core, eq, eval_, funcall, if_, iff, inc, jsfun, jsobject, lamda, le, loop_, macall, macro, makeLabel, not_, print_, protect, qq, quote, solve, string, suffixinc, throw_, until_, uq, uqs, vari, while_, xexports, _, _ref;
  ...
  exports.Test = {
    ...
    "test block break continue": function(test) {
      ...
      test.equal(solve(begin(assign(x, 1), block(a, if_(eq(x, 10000), break_(a, x)), inc(x), continue_(a)))), 10000);
      return test.done();
    }
  };
