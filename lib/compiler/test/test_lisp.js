...
(function() {
  var add, assign, begin, block, break_, catch_, continue_, core, eq, eval_, funcall, if_, iff, inc, jsfun, jsobject, lamda, le, loop_, macall, macro, makeLabel, not_, print_, protect, qq, quote, solve, string, suffixinc, throw_, until_, uq, uqs, vari, while_, xexports, _, _ref,
    __slice = [].slice;
