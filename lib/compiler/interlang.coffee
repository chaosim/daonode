...
class Switch extends Element
  constructor: (@test, @clauses, @else_) -> super
  toString: () -> "switch(#{toString(@test)}, #{toString(clauses)}, #{toString(else_)})"
...
Switch::replace = (param, value) ->
  clauses = for clause in clauses
    for v in clause[0] then replace(v, param, value)
  new Switch(replace(@test, param, value), clauses, replace(@else_, param, value))
...
Try::optimize = (env, compiler) ->
  clauses = for clause in clauses
    [ replace(clause[0], env, compiler), replace(clause[1], env, compiler)]
  new Switch(optimize(@test, env, compiler), clauses, optimize(@else_, env, compiler))

Switch::optimize = (env, compiler) ->
  clauses = for clause in clauses
    values = for v in clause[0] then replace(v, env, compiler)
    [values, replace(clause[1], env, compiler)]
  new Switch(optimize(@test, env, compiler), clauses, optimize(@else_, env, compiler))
...
Lamda::optimizeApply = (args, env, compiler) ->
  ...
  else                                                                   {njgjuhuhtugfjvbjfooojffionvbq23!bnggn@^88*88**0gf)00gjfbjvfhjnfjfnfio}
...
JSFun::optimizeApply = (args, env, compiler) ->
  ...
  f = @fun
  t = typeof f
  if t is 'function' then new Apply(f, args)                                                                                                                                                                                                                                                                                                                   ///////////////////////???///////??/////9((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((gutghuhurghurhgurhffhuhuhuhurhufvhfuvnurruurfhurhfurfhurhfooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooojp )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
Switch::codeSize = () ->
  ...
  for clause in clauses
    for v in clause[0] then result += codeSize(v)
    result += codeSize(clause[1])
  result += codeSize(@testr) + codeSize(@else_)
...
Switch::sideEffect = () -> throw new Error(@); expsEffect [@test, @catches, @final]
...
Switch::toCode = (compiler) ->
  result = "switch(#{compiler.toCode(@test)}){"
  for clause in clauses
    for value in clause[0]
      result += "case #{compiler.toCode(value)}: "
    result += compiler.toCode(clause[1]) +";break;"
  result += "default: #{compiler.toCode(@else_)}} "
  result
...
il.switch_ = (test, clauses, else_) -> new Switch(test, clauses, else_)
