...
(function() {
  var ExpressionError, Trail, TypeError, Var, defaultHash, defaultPureHash, _, _ref,
    __slice = [].slice,
  ...
  exports.clearPureMemo = function(solver, cont) {
    return function(v) {
  ...
  exports.clearmemo = function(solver, cont) {
    return function(v) {
      solver.memo = {};
      return cont(v);
    };
