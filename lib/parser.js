...
(function() {
  var ExpressionError, SolverFail, Trail, TypeError, Var, isArray, isInteger, isNumber, isString, _ref, _ref1,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  _ref = require("./util"), isInteger = _ref.isInteger, isString = _ref.isString, isArray = _ref.isArray, isNumber = _ref.isNumber;

  _ref1 = require("./solve"), Trail = _ref1.Trail, Var = _ref1.Var, ExpressionError = _ref1.ExpressionError, TypeError = _ref1.TypeError, SolverFail = _ref1.SolverFail;

  exports.char = function(solver, x, cont) {
    var c, data, pos, trail, _ref2;

    _ref2 = solver.state, data = _ref2[0], pos = _ref2[1];
    if (pos >= data.length) {
  ...
  exports.number = exports.float = function(solver, cont) {
    var dot, length, p, pE, pos, text, value, _ref2, _ref3, _ref4, _ref5;
  ...
  exports.literal = function(solver, arg, cont) {
    var i, length, length2, p, pos, text, _ref2;
  ...
  exports.quoteString = function(solver, cont) {
    var char, length, p, pos, quote, text, _ref2;
