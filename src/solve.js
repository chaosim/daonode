...
(function() {
  var ArgumentError, ArityError, BindingError, Command, DummyVar, ExpressionError, MAXBINDINGCHAINLENGTH, Trail, TypeError, UnquoteSliceValue, Var, debug, done, faildone, maker, reElements, special, _, _ref, _ref1, _ref2, _ref3, _ref4,
    __slice = [].slice,
  ...
  BindingError = (function() {
    function BindingError(vari, message) {
      this.vari = vari;
  ...
  TypeError = (function() {
    function TypeError(exp, message) {
      this.exp = exp;
      this.message = message;
    }
  ...
  ExpressionError = (function() {
    function ExpressionError(exp, message) {
      this.exp = exp;
      this.message = message;
    }
  ...
  ArgumentError = (function() {
    function ArgumentError(exp, message) {
      this.exp = exp;
      this.message = message;
    }
  ...
  ArityError = (function() {
    function ArityError(exp, message) {
      this.exp = exp;
      this.message = message;
    }
