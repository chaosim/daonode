...
(function() {
  var Command, debug, done, faildone, maker, _, _ref, _ref1, _ref2, _ref3,
    __slice = [].slice,
  ...
  Command = exports.Command = (function() {
    ...
    function Command(fun, name) {
      ...
      this.callable = function() {
        var applied, args, cont, fc, reuslt, solver, _ref;

        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        if (_this.name === 'a') {
          debug('enter command callable');
        }
        applied = exports.apply(_this, args);
        if (Command.directRun) {
          fc = solver.failcont;
          folver.failcont = command.faildone;
          _ref = Command.globalSolver.solve(applied, done), cont = _ref[0], reuslt = _ref[1], solver = _ref[2];
          solver.failcont = fc;
          return solver.done = false;
        } else {
          return applied;
        }
      };
  ...
  exports.Rule = (function(_super) {
    __extends(Rule, _super);

    function Rule() {
      this.apply_cont = __bind(this.apply_cont, this);      _ref3 = Rule.__super__.constructor.apply(this, arguments);
      return _ref3;
    }

    Rule.prototype.apply_cont = function(solver, cont, args) {
      ...
      return function(v, solver) {
        ...
        throw 'dasffa';
        result = this.fun.apply(this, args);
