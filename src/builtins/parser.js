...
(function() {
  var ExpressionError, Trail, TypeError, Var, any1, any2, checkFunction, dao, dqstring, greedyany1, greedyany2, greedysome1, greedysome2, lazyany1, lazyany2, lazysome1, lazysome2, logic, name, numberTimes1Fun, numberTimes2Fun, parallelFun, solve, some1, some2, special, sqstring, times1, times1Fun, times2, times2Fun, _, _ref,
    __slice = [].slice,
  ...
  exports.seplist1 = function(exp, options) {
    var andp, bind, expectTimes, getvalue, i, is_, list, n, one, push, result, sep, succeed, template;
