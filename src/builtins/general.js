...
(function() {
  ...
  exports.inc = special('inc', function(cont, vari) {
    return function() {
  ...
  exports.inc2 = special('inc2', function(cont, vari) {
    return function() {
  ...
  exports.dec = special('dec', function(cont, vari) {
    return function() {
      vari.binding = vari.binding - 1;
      return cont();
    };
  ...
  exports.dec2 = special('dec2', function(cont, vari) {
    return function() {
      vari.binding = vari.binding - 2;
      return cont();
    };
