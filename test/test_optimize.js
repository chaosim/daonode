...
(function() {
  var Compiler, OptimizationEnv, beautify, compile, compileToCode, compiler, fs, il, internalconst, internalvar, solve, uservar, vari, xexports, _, _ref;
  ...
  _ref = require('../lib/core'), Compiler = _ref.Compiler, OptimizationEnv = _ref.OptimizationEnv;
  ...
  internalconst = function(name) {
    return compiler.newconst(il.internalvar(name));
  };
  ...
  exports.Test = {
    ...
    "test assign in if_": function(test) {
      var a, b, env, f, n;
