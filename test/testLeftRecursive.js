...
(function() {
  var BaseParser, Parser1, Parser2, get, set, xexports, _ref,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  _ref = require("../lib/leftrecursive.js"), BaseParser = _ref.BaseParser, set = _ref.set, get = _ref.get;
  ...
  Parser1 = (function(_super) {
    ...
    function Parser1() {
      this.A = __bind(this.A, this);      Parser1.__super__.constructor.apply(this, arguments);
      this.addRecCircles(['A']);
      this.setMemoRules();
      this.Root = this.A;
    }
  ...
  Parser2 = (function(_super) {
    ...
    function Parser2() {
      ...
      this.A = __bind(this.A, this);      Parser2.__super__.constructor.apply(this, arguments);
      this.addRecCircles(['A', 'B']);
      this.setMemoRules();
      this.Root = this.A;
    }
    ...
    Parser2.prototype.A = function(start) {
      ...
      return (memo = this.memo('B')(start)) && this.char('x')(this.cursor) && memo + 'x' || memo || this.char('a')(start);
    };

    Parser2.prototype.B = function(start) {
      return this.memo('A')(start) || this.char('b')(start);
    };
