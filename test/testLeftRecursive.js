...
(function() {
  var a, addRecCircles, b, char, computeLeftRecursives, hasOwnProperty, memo, memoA, p, parse1, parse2, parse3, parser, prepareGrammar, setRules, x, xexports, _ref;

  _ref = parser = p = require("../lib/leftRecursive.js"), prepareGrammar = _ref.prepareGrammar, char = _ref.char, memo = _ref.memo, setRules = _ref.setRules, addRecCircles = _ref.addRecCircles, computeLeftRecursives = _ref.computeLeftRecursives;
