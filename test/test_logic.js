...
(function() {
  var add, andp, array, assign, begin, cons, core, cut, cutable, eq, fail, findall, funcall, getvalue, if_, inc, lamda, le, logicvar, macro, makeobject, not_, notp, once, orp, print_, solve, solvebase, string, succeed, uarray, unify, uobject, vari, xexports, _, _ref;
