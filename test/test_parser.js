...
(function() {
  var Error, add, andp, any, assign, begin, boi, bol, char, core, dummy, eoi, eol, eq, findall, follow, funcall, getcursor, getdata, getstate, getvalue, greedyany, greedymay, greedysome, if_, inc, jsfun, lamda, lazyany, lazymay, lazysome, leftdata, literal, logicvar, macall, macro, may, nextchar, notfollow, number, orp, parallel, parsedata, print_, quote, seplist, setdata, solve, some, step, string, subdata, suffixinc, times, vari, xexports, _ref, _ref1;

  _ref = core = require('../lib/core'), solve = _ref.solve, Error = _ref.Error;

  _ref1 = require('../lib/util'), string = _ref1.string, begin = _ref1.begin, quote = _ref1.quote, assign = _ref1.assign, print_ = _ref1.print_, funcall = _ref1.funcall, macall = _ref1.macall, lamda = _ref1.lamda, macro = _ref1.macro, jsfun = _ref1.jsfun, if_ = _ref1.if_, add = _ref1.add, eq = _ref1.eq, inc = _ref1.inc, suffixinc = _ref1.suffixinc, logicvar = _ref1.logicvar, dummy = _ref1.dummy, andp = _ref1.andp, orp = _ref1.orp, findall = _ref1.findall, getvalue = _ref1.getvalue, getstate = _ref1.getstate, getdata = _ref1.getdata, getcursor = _ref1.getcursor, eoi = _ref1.eoi, boi = _ref1.boi, eol = _ref1.eol, bol = _ref1.bol, step = _ref1.step, leftdata = _ref1.leftdata, subdata = _ref1.subdata, nextchar = _ref1.nextchar, parsedata = _ref1.parsedata, char = _ref1.char, setdata = _ref1.setdata, number = _ref1.number, literal = _ref1.literal, may = _ref1.may, greedymay = _ref1.greedymay, lazymay = _ref1.lazymay, any = _ref1.any, lazyany = _ref1.lazyany, greedyany = _ref1.greedyany, some = _ref1.some, lazysome = _ref1.lazysome, greedysome = _ref1.greedysome, times = _ref1.times, seplist = _ref1.seplist, parallel = _ref1.parallel, follow = _ref1.follow, notfollow = _ref1.notfollow;
  ...
  exports.Test = {
    ...
    "test lazyany": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(lazyany(char(_), result, _), string('a')), getvalue(result))), []);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), lazyany(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
    ...
    "test any": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(any(char(_), result, _), string('a')), getvalue(result))), ['a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), any(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
    ...
    "test greedyany": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(greedyany(char(_), result, _), string('a')), getvalue(result))), ['a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), greedyany(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
      return test.done();
    },
    "test lazysome": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(lazysome(char(_), result, _), string('a')), getvalue(result))), ['a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), lazysome(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
    ...
    "test greedysome": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(greedysome(char(_), result, _), string('a')), getvalue(result))), ['a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), greedysome(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
    ...
    "test some": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(some(char(_), result, _), string('a')), getvalue(result))), ['a']);
      test.equal(core.status, core.SUCCESS);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), setdata(string('ab')), some(char(_), result, _), eoi, getvalue(result))), ['a', 'b']);
    ...
    "test times": function(test) {
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), setdata(string('ab')), times(char(_), n), eoi)), true);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(times(char(_), 2, result, _), string('ab')), getvalue(result))), ['a', 'b']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(times(char(_), 3, result, _), string('abc')), getvalue(result))), ['a', 'b', 'c']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), setdata(string('ab')), times(char(_), n, result, _), eoi, getvalue(result))), ['a', 'b']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), setdata(string('aabb')), times(char(string('a')), n), times(char(string('b')), n), eoi, getvalue(n))), 2);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), setdata(string('ab')), times(char(_), n, result, _), eoi, getvalue(n))), 2);
      test.deepEqual(solve(begin(setdata(string('aaabbb')), assign(n, logicvar('n')), assign(result, logicvar('result')), times(char(string('a')), n, result, string('a')), times(char(string('b')), n), eoi, getvalue(n))), 3);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), setdata(string('abc')), times(char(_), n, result, _), char(string('c')), eoi, getvalue(result))), ['a', 'b']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), setdata(string('abc')), times(char(_), n, result, _), char(string('b')), char(string('c')), eoi, getvalue(result))), ['a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), setdata(string('aaabbb')), times(char(string('a')), n), times(char(string('b')), n), eoi, getvalue(n))), 3);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), setdata(string('a')), times(char(_), n, result, _), char(string('a')), eoi, getvalue(result))), []);
      test.deepEqual(solve(begin(setdata(string('aaabbb')), assign(n, logicvar('n')), assign(result, logicvar('result')), times(char(string('a')), n, result, string('a')), times(char(string('b')), n, result, string('b')), eoi, getvalue(result))), false);
      test.deepEqual(solve(begin(setdata(string('aaabbb')), assign(n, logicvar('n')), assign(result, dummy('result')), times(char(string('a')), n, result, string('a')), times(char(string('b')), n, result, string('b')), eoi, getvalue(result))), ['b', 'b', 'b']);
      return test.done();
    },
    "test seplist": function(test) {
      ...
      test.equal(solve(begin(assign(_, dummy('__')), parsedata(seplist(char(_), {
        sep: char(string(','))
      }), string('a,a')))), 3);
      test.equal(solve(begin(assign(_, dummy('__')), parsedata(seplist(char(_), {
        sep: char(string(',')),
    ...
    "test seplist2": function(test) {
      ...
      result = vari('result');
      n = vari('n');
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(result, logicvar('result')), parsedata(seplist(char(_), {
        sep: char(string(',')),
        times: 3,
        result: result,
        template: string('a')
      }), string('a,a,a')), getvalue(result))), ['a', 'a', 'a']);
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), parsedata(seplist(char(_), {
        sep: char(string(',')),
        times: 3,
        result: result,
        template: _
      ...
      test.deepEqual(solve(begin(assign(_, dummy('__')), assign(n, logicvar('n')), assign(result, logicvar('result')), parsedata(andp(seplist(char(_), {
        sep: char(string(',')),
        times: n,
        result: result,
        template: _
