...
{Trail, solve, fun, macro, vari} = core = require "../../lib/interpreter/core"
...
{quote, eval_} = require "../../lib/interpreter/builtins/lisp"
{char, parsetext, may, any} = require "../../lib/interpreter/builtins/parser"
