...
(function() {
  var andp, any, begin, char, fail, findall, greedyany, greedymay, lazyany, may, notp, once, orp, parsetext, rule, settext, succeed, unify, xexports, _ref;

  _ref = require("../../experiment/paramsolver"), andp = _ref.andp, orp = _ref.orp, notp = _ref.notp, succeed = _ref.succeed, fail = _ref.fail, unify = _ref.unify, findall = _ref.findall, once = _ref.once, rule = _ref.rule, begin = _ref.begin, char = _ref.char, parsetext = _ref.parsetext, settext = _ref.settext, may = _ref.may, greedymay = _ref.greedymay, any = _ref.any, greedyany = _ref.greedyany, lazyany = _ref.lazyany;
...
/*
//@ sourceMappingURL=testparamsolver.map
*/
