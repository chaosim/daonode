...
{solve, vari, Trail, fun, fun2, macro, proc, rule, tofun, dummy
done, faildone, UnquoteSliceValue} = core = require('../core')
#I.use base+"builtins/general: add print_, sub, eq, inc"
{add, print_, inc, dec, eq, le} = require "../builtins/general"
{quote, eval_, if_, iff, begin, quote, eval_, block, break_, continue_, assign, loop_, while_, until_
catch_, throw_, protect, callcc, callfc, qq, uq, uqs} = require "../builtins/lisp"
{orp} = require "../builtins/logic"
